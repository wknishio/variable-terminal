...
import static org.vash.vate.io.airlift.compress.zstd.Constants.MAX_OFFSET_CODE_SYMBOL;
...
import static org.vash.vate.io.airlift.compress.zstd.FiniteStateEntropy.optimalTableLog;
...
class SequenceEncoder
{
    ...
    public static int compressSequences(Object outputBase, final long outputAddress, int outputSize, SequenceStore sequences, CompressionParameters.Strategy strategy, SequenceEncodingContext workspace)
    {
        ...
        // flags
        UnsafeUtils.putByte(outputBase, headerAddress, (byte) ((literalsLengthEncodingType << 6) | (offsetEncodingType << 4) | (matchLengthEncodingType << 2)));
