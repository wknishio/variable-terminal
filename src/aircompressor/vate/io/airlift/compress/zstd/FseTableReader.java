...
import static vate.io.airlift.compress.zstd.FiniteStateEntropy.MAX_SYMBOL;
import static vate.io.airlift.compress.zstd.FiniteStateEntropy.MIN_TABLE_LOG;
import static vate.io.airlift.compress.zstd.ZstdUtil.highestBit;
