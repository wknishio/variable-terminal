...
import static vate.io.airlift.compress.zstd.BitInputStream.peekBits;
import static vate.io.airlift.compress.zstd.Constants.COMPRESSED_BLOCK;
import static vate.io.airlift.compress.zstd.Constants.COMPRESSED_LITERALS_BLOCK;
import static vate.io.airlift.compress.zstd.Constants.DEFAULT_MAX_OFFSET_CODE_SYMBOL;
import static vate.io.airlift.compress.zstd.Constants.LITERALS_LENGTH_BITS;
import static vate.io.airlift.compress.zstd.Constants.LITERAL_LENGTH_TABLE_LOG;
import static vate.io.airlift.compress.zstd.Constants.LONG_NUMBER_OF_SEQUENCES;
import static vate.io.airlift.compress.zstd.Constants.MAGIC_NUMBER;
import static vate.io.airlift.compress.zstd.Constants.MATCH_LENGTH_BITS;
import static vate.io.airlift.compress.zstd.Constants.MATCH_LENGTH_TABLE_LOG;
import static vate.io.airlift.compress.zstd.Constants.MAX_BLOCK_SIZE;
import static vate.io.airlift.compress.zstd.Constants.MAX_LITERALS_LENGTH_SYMBOL;
import static vate.io.airlift.compress.zstd.Constants.MAX_MATCH_LENGTH_SYMBOL;
import static vate.io.airlift.compress.zstd.Constants.MIN_BLOCK_SIZE;
import static vate.io.airlift.compress.zstd.Constants.MIN_SEQUENCES_SIZE;
import static vate.io.airlift.compress.zstd.Constants.MIN_WINDOW_LOG;
import static vate.io.airlift.compress.zstd.Constants.OFFSET_TABLE_LOG;
import static vate.io.airlift.compress.zstd.Constants.RAW_BLOCK;
import static vate.io.airlift.compress.zstd.Constants.RAW_LITERALS_BLOCK;
import static vate.io.airlift.compress.zstd.Constants.RLE_BLOCK;
import static vate.io.airlift.compress.zstd.Constants.RLE_LITERALS_BLOCK;
import static vate.io.airlift.compress.zstd.Constants.SEQUENCE_ENCODING_BASIC;
import static vate.io.airlift.compress.zstd.Constants.SEQUENCE_ENCODING_COMPRESSED;
import static vate.io.airlift.compress.zstd.Constants.SEQUENCE_ENCODING_REPEAT;
import static vate.io.airlift.compress.zstd.Constants.SEQUENCE_ENCODING_RLE;
import static vate.io.airlift.compress.zstd.Constants.SIZE_OF_BLOCK_HEADER;
import static vate.io.airlift.compress.zstd.Constants.SIZE_OF_BYTE;
import static vate.io.airlift.compress.zstd.Constants.SIZE_OF_INT;
import static vate.io.airlift.compress.zstd.Constants.SIZE_OF_LONG;
import static vate.io.airlift.compress.zstd.Constants.SIZE_OF_SHORT;
import static vate.io.airlift.compress.zstd.Constants.TREELESS_LITERALS_BLOCK;
import static vate.io.airlift.compress.zstd.ZstdUtil.fail;
import static vate.io.airlift.compress.zstd.ZstdUtil.get24BitLittleEndian;
import static vate.io.airlift.compress.zstd.ZstdUtil.mask;
import static vate.io.airlift.compress.zstd.ZstdUtil.verify;
