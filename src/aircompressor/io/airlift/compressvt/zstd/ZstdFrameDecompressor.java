 ...
 */
package io.airlift.compressvt.zstd;

import static io.airlift.compressvt.zstd.BitInputStream.peekBits;
import static io.airlift.compressvt.zstd.Constants.COMPRESSED_BLOCK;
import static io.airlift.compressvt.zstd.Constants.COMPRESSED_LITERALS_BLOCK;
import static io.airlift.compressvt.zstd.Constants.DEFAULT_MAX_OFFSET_CODE_SYMBOL;
import static io.airlift.compressvt.zstd.Constants.LITERALS_LENGTH_BITS;
import static io.airlift.compressvt.zstd.Constants.LITERAL_LENGTH_TABLE_LOG;
import static io.airlift.compressvt.zstd.Constants.LONG_NUMBER_OF_SEQUENCES;
import static io.airlift.compressvt.zstd.Constants.MAGIC_NUMBER;
import static io.airlift.compressvt.zstd.Constants.MATCH_LENGTH_BITS;
import static io.airlift.compressvt.zstd.Constants.MATCH_LENGTH_TABLE_LOG;
import static io.airlift.compressvt.zstd.Constants.MAX_BLOCK_SIZE;
import static io.airlift.compressvt.zstd.Constants.MAX_LITERALS_LENGTH_SYMBOL;
import static io.airlift.compressvt.zstd.Constants.MAX_MATCH_LENGTH_SYMBOL;
import static io.airlift.compressvt.zstd.Constants.MIN_BLOCK_SIZE;
import static io.airlift.compressvt.zstd.Constants.MIN_SEQUENCES_SIZE;
import static io.airlift.compressvt.zstd.Constants.MIN_WINDOW_LOG;
import static io.airlift.compressvt.zstd.Constants.OFFSET_TABLE_LOG;
import static io.airlift.compressvt.zstd.Constants.RAW_BLOCK;
import static io.airlift.compressvt.zstd.Constants.RAW_LITERALS_BLOCK;
import static io.airlift.compressvt.zstd.Constants.RLE_BLOCK;
import static io.airlift.compressvt.zstd.Constants.RLE_LITERALS_BLOCK;
import static io.airlift.compressvt.zstd.Constants.SEQUENCE_ENCODING_BASIC;
import static io.airlift.compressvt.zstd.Constants.SEQUENCE_ENCODING_COMPRESSED;
import static io.airlift.compressvt.zstd.Constants.SEQUENCE_ENCODING_REPEAT;
import static io.airlift.compressvt.zstd.Constants.SEQUENCE_ENCODING_RLE;
import static io.airlift.compressvt.zstd.Constants.SIZE_OF_BLOCK_HEADER;
import static io.airlift.compressvt.zstd.Constants.SIZE_OF_BYTE;
import static io.airlift.compressvt.zstd.Constants.SIZE_OF_INT;
import static io.airlift.compressvt.zstd.Constants.SIZE_OF_LONG;
import static io.airlift.compressvt.zstd.Constants.SIZE_OF_SHORT;
import static io.airlift.compressvt.zstd.Constants.TREELESS_LITERALS_BLOCK;
import static io.airlift.compressvt.zstd.ZstdUtil.fail;
import static io.airlift.compressvt.zstd.ZstdUtil.get24BitLittleEndian;
import static io.airlift.compressvt.zstd.ZstdUtil.mask;
import static io.airlift.compressvt.zstd.ZstdUtil.verify;
import static java.lang.String.format;

import org.vash.vate.compatibility.VTArrays;

import io.airlift.compressvt.MalformedInputException;
import io.airlift.compressvt.UnsafeUtils;
