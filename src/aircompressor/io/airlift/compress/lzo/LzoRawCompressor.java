...
public final class LzoRawCompressor
{
            ...
            final long literalLength)
    {
        ...
        System.arraycopy(inputBase, (int)inputAddress - CompatConsts.ARRAY_BYTE_BASE_OFFSET, outputBase, (int)output - CompatConsts.ARRAY_BYTE_BASE_OFFSET, (int)literalLength);
        ...
        UNSAFE.putByte(outputBase, output++, (byte) 0x11);
    ...
    private static long emitCopy(Object outputBase, long output, int matchOffset, int matchLength)
    {
        ...
        if (matchLength <= 8 && matchOffset <= 2048) {
            ...
            UNSAFE.putByte(outputBase, output++, (byte) (((matchLength) << 5) | ((matchOffset & 0x7) << 2)));
