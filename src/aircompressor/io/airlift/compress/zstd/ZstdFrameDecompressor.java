...
import io.airlift.compress.CompatConsts;
...
import static io.airlift.compress.CompatConsts.ARRAY_BYTE_BASE_OFFSET;
...
class ZstdFrameDecompressor
{
            ...
            final long outputLimit)
    {
        ...
        while (input < inputLimit) {
            ...
            do {
                ...
                // read block header
                int header = UNSAFE.getInt(inputBase, input) & 0xFFFFFF;
    ...
    private static int decodeRawBlock(Object inputBase, long inputAddress, int blockSize, Object outputBase, long outputAddress, long outputLimit)
    {
        ...
        System.arraycopy(inputBase, (int)inputAddress - CompatConsts.ARRAY_BYTE_BASE_OFFSET, outputBase, (int)outputAddress - CompatConsts.ARRAY_BYTE_BASE_OFFSET, blockSize);
    ...
    private int decodeCompressedBlock(Object inputBase, final long inputAddress, int blockSize, Object outputBase, long outputAddress, long outputLimit, int windowSize, long outputAbsoluteBaseAddress)
    {
        ...
        // decode literals
        int literalsBlockType = UNSAFE.getByte(inputBase, input) & 0x3;
    ...
    private long copyLastLiteral(Object outputBase, Object literalsBase, long literalsLimit, long output, long literalsInput)
    {
        ...
        System.arraycopy(literalsBase, (int)literalsInput - CompatConsts.ARRAY_BYTE_BASE_OFFSET, outputBase, (int)output - CompatConsts.ARRAY_BYTE_BASE_OFFSET, (int)lastLiteralsSize);
    ...
    private int decodeCompressedLiterals(Object inputBase, final long inputAddress, int blockSize, int literalsBlockType)
    {
        ...
        int headerSize;
        int type = (UNSAFE.getByte(inputBase, input) >> 2) & 0x3;
        switch (type) {
            case 0:
                singleStream = true;
            case 1: {
            ...
            case 3: {
                ...
                long header = UNSAFE.getByte(inputBase, input) & 0xFF |
                        (UNSAFE.getInt(inputBase, input + 1) & 0xFFFFFFFFL) << 8;
    ...
    private int decodeRawLiterals(Object inputBase, final long inputAddress, long inputLimit)
    {
        ...
        if (literalSize > (inputLimit - input) - SIZE_OF_LONG) {
            ...
            System.arraycopy(inputBase, (int)input - CompatConsts.ARRAY_BYTE_BASE_OFFSET, literals, (int)literalsAddress - CompatConsts.ARRAY_BYTE_BASE_OFFSET, (int)literalSize);
