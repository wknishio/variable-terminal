...
public final class VTImageIO
{
  ...
  // private static final void decodeTwoPixelByte(VTLittleEndianInputStream in,
  // byte[] pixelData, int position) throws IOException
  // {
  ...
  /*
   * private static final int to24bitInt(int value) { return -(value & 0x00800000)
   * + (value & ~0x00800000); } private static final int from24bitInt(int value) {
   * if ((value & 0x00800000) != 0) { value |= 0xFF000000; } else { value &=
   * 0x00FFFFFF; } return value; }
   */
}