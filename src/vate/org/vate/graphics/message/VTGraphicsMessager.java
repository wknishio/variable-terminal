...
public class VTGraphicsMessager
{
	...
	static
	{
		try
		{
			warningIcon16 = ImageIO.read(VTGraphicsMessager.class.getResourceAsStream("/org/vate/graphics/message/resource/warning16.png"));
			warningIcon32 = ImageIO.read(VTGraphicsMessager.class.getResourceAsStream("/org/vate/graphics/message/resource/warning32.png"));
			// displayIcon =
			// ImageIO.read(VTGraphicsMessager.class.getResourceAsStream("/org/vate/graphics/message/resource/warning.png"));
		}
		catch (Throwable e)
		{
		...
		try
		{
			...
			dialog.addKeyListener(new KeyListener()
			{
				...
				public void keyTyped(KeyEvent e)
				{
					 ...
					 * KeyEvent(button, e.getID(), e.getWhen(),
					 * e.getModifiersEx(), e.getKeyCode(), ' ',
					 * e.getKeyLocation())); } */
				}
			});
			...
			dialog.addWindowListener(new WindowListener()
			{
				...
				{
					/* Container container = e.getComponent().getParent(); if
					 * (container instanceof Frame) { Frame frame = (Frame)
