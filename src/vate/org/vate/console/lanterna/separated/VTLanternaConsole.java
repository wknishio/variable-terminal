...
public class VTLanternaConsole implements VTConsoleImplementation
{
  ...
  public void build() throws Exception
  {
    ...
    outputBox = new VTLanternaOutputTextBox(new TerminalSize(80, 24), "", Style.MULTI_LINE, 360);
    ...
    if (terminal instanceof AWTTerminalFrame)
    {
      ...
      {
        // InputStream stream =
        // this.getClass().getResourceAsStream("/org/vate/console/graphical/resource/terminal.png");
        try
        {
...
//        	});
    ...
    inputBox.setInputFilter(new InputFilter()
    {
      public boolean onInput(Interactable interactable, KeyStroke keyStroke)
      {
        ...
        if (keyStroke.getKeyType() == KeyType.ArrowLeft || keyStroke.getKeyType() == KeyType.ArrowRight || keyStroke.getKeyType() == KeyType.Backspace || keyStroke.getKeyType() == KeyType.Delete || keyStroke.getKeyType() == KeyType.Home || keyStroke.getKeyType() == KeyType.End)
        {
          ...
          inputBox.handleDataInput(currentLineBuffer, keyStroke);
          if (!echoInput)
          {
            return false;
          }
