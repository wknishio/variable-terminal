...
public class VTGraphicalConsoleMouseListener implements MouseListener
{
	...
	public void mousePressed(MouseEvent e)
	{
		if (e.isPopupTrigger())
		{
			 ...
			 * StringSelection(selectedText); systemClipboard.setContents(text,
			 * null); //VTGraphicalConsole.unselectAllText();
			 ...
			 * VTGraphicalConsole.input(text); } } catch
			 * (UnsupportedFlavorException e1) {
