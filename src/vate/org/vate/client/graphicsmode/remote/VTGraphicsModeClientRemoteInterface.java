package org.vate.client.graphicsmode.remote;
...
public class VTGraphicsModeClientRemoteInterface extends Canvas
{
  ...
  public void prepareDisplay(BufferedImage image)
  {
    ...
    if (image.getType() != BufferedImage.TYPE_INT_RGB && image.getType() != BufferedImage.TYPE_INT_ARGB && image.getType() != BufferedImage.TYPE_USHORT_555_RGB)
    {
  ...
  public void refreshImage()
  {
    ...
    // Graphics2D displayGraphics = displayImageGraphics;
    if (sourceImageDataBuffer != null && displayImageGraphics != null && displayImageDataBuffer != null && sourceImageDataBuffer.getType() != BufferedImage.TYPE_INT_RGB && sourceImageDataBuffer.getType() != BufferedImage.TYPE_INT_ARGB && sourceImageDataBuffer.getType() != BufferedImage.TYPE_USHORT_555_RGB)
    {
      ...
      // Rectangle area = refreshArea;
      try
      {
        // displayImageGraphics.drawImage(sourceImageDataBuffer, 0, 0, null);
  ...
  public void paint(Graphics g)
  {
    ...
    if (sourceImageDataBuffer != null)
    {
      ...
      try
      {
        if (sourceImageDataBuffer.getType() != BufferedImage.TYPE_INT_RGB && sourceImageDataBuffer.getType() != BufferedImage.TYPE_INT_ARGB && sourceImageDataBuffer.getType() != BufferedImage.TYPE_USHORT_555_RGB)
        {
