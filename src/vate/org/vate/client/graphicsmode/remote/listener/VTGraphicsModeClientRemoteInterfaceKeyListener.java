...
public class VTGraphicsModeClientRemoteInterfaceKeyListener implements KeyListener
{
	...
	public void keyPressed(KeyEvent event)
	{
		 ...
		 * (event.getKeyLocation() == KeyEvent.KEY_LOCATION_RIGHT) { return; }
		 * //Try preventing some local key combinations
		...
		if (!interrupted && writer.isSuppressLocalKeyCombinations())
		{
			 ...
			 * event.getKeyCode() == KeyEvent.VK_ALT || event.getKeyCode() ==
			 * KeyEvent.VK_ALT_GRAPH || event.getKeyCode() == KeyEvent.VK_SHIFT
			 * || event.getKeyCode() == KeyEvent.VK_META || event.getKeyCode()
			 * == KeyEvent.VK_WINDOWS || event.getKeyCode() ==
			 * KeyEvent.VK_CONTEXT_MENU) { return; } */
