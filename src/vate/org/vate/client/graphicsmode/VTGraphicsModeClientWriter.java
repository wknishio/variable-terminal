...
import org.vate.client.graphicsmode.listener.VTGraphicsModeClientWindowListener;
import org.vate.client.graphicsmode.options.VTGraphicsModeClientOptionsMenuBar;
import org.vate.client.graphicsmode.remote.VTGraphicsModeClientRemoteInterface;
import org.vate.client.graphicsmode.remote.VTGraphicsModeClientRemoteInterfaceRefresher;
import org.vate.client.graphicsmode.remote.listener.VTGraphicsModeClientRemoteInterfaceFocusListener;
import org.vate.client.graphicsmode.remote.listener.VTGraphicsModeClientRemoteInterfaceKeyListener;
import org.vate.client.graphicsmode.remote.listener.VTGraphicsModeClientRemoteInterfaceMouseListener;
...
public class VTGraphicsModeClientWriter implements Runnable
{
	...
	private static final double IMAGE_SCALE_MULTIPLIER_FACTOR = Math.pow(2D, (1D / 4D));
		...
		public void run()
		{
			try
			{
				...
				else
				{
					...
					if (lastFrameState != Frame.NORMAL || lastFrameState != Frame.ICONIFIED)
					{
	...
	public void dispose()
	{
		...
		drawPointer = true;
		screenCaptureMode = VT.VT_GRAPHICS_MODE_GRAPHICS_CAPTURE_MODE_SCALED_PARTIAL;
	...
	/* public void setScreenCaptureModeComplete(boolean
	 * screenCaptureModeComplete) { this.screenCaptureModeComplete =
	 * screenCaptureModeComplete; } */
	 ...
	 * ignoreIconification = false; menuBar.setIgnoreIconification(false); }
	 * else { ignoreFocus = true; ignoreIconification = true;
	...
	public void updateCaptureScale(int captureScale)
	{
		if (screenCaptureMode == VT.VT_GRAPHICS_MODE_GRAPHICS_CAPTURE_MODE_ADJUSTED_KEEP_RATIO || screenCaptureMode == VT.VT_GRAPHICS_MODE_GRAPHICS_CAPTURE_MODE_ADJUSTED_IGNORE_RATIO)
		{
			setScreenCaptureMode(VT.VT_GRAPHICS_MODE_GRAPHICS_CAPTURE_MODE_SCALED_PARTIAL);
		}
	...
	public Rectangle calculateScreenCaptureArea()
	{
		...
		if (screenCaptureMode == VT.VT_GRAPHICS_MODE_GRAPHICS_CAPTURE_MODE_SCALED_COMPLETE)
		{
			area.x = -1;
			area.y = -1;
		}
	...
	public void resizeRemoteGraphics(int width, int height)
	{
		 ...
		 * scrolled.getViewportSize().height) / 2); synchronized
		 * (graphicsRefresher) { graphicsRefresher.notify(); } } */
	}
