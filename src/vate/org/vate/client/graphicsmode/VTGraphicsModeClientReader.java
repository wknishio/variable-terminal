...
public class VTGraphicsModeClientReader implements Runnable
{
	...
	private class VTIncrementalIIOReadUpdateListener implements IIOReadUpdateListener
	{
		...
		{
			//System.out.println("imageUpdate:" + minX + "," + minY + "," + width + "," + height);
		...
		public void passComplete(ImageReader source, BufferedImage theImage)
		{
			...
			//currentImageGraphics.drawImage(theImage, offsetX + passMinX, offsetY + passMinY, offsetX + passMinX + theImage.getWidth(), offsetY + passMinY + theImage.getHeight(), passMinX, passMinY, passMinX + theImage.getWidth(), passMinY + theImage.getHeight(), null);
		}
			...
			try
			{
				switch (connection.getGraphicsControlDataInputStream().read())
				{
					case VT.VT_GRAPHICS_MODE_GRAPHICS_NEW_FRAME_IMAGE:
					{
						...
						//refreshArea.height = connection.getGraphicsControlDataInputStream().readInt();
