...
//		dialog = false;
  ...
  private void setMultiplexedStreams() throws IOException
  {
    ...
    // VTCompressorSelector.createCompatibleSyncFlushDeflaterOutputStream(shellOutputStream);
    ...
    // VTCompressorSelector.createCompatibleSyncFlushInflaterInputStream(shellInputStream);
