...
public class VTClientConnector implements Runnable
{
  ...
  public boolean setServerSocket(String address, Integer port)
  {
    try
    {
       ...
       * = null; connectionServerSocket = new SocksServerSocket(proxy, nullHost,
       * port); return true; } else { connectionServerSocket = new ServerSocket();
...
//		}
  ...
  public boolean listenConnection(VTClientConnection connection)
  {
    ...
    try
    {
       ...
       * connection.setEncryptionType(VT.VT_CONNECTION_ENCRYPT_HC128); } else if
       * (encryptionType.toUpperCase().startsWith("G")) {
      ...
      if (line.toUpperCase().startsWith("P"))
      {
        ...
        else
        {
          ...
          if (line.toUpperCase().startsWith("Y"))
          {
            ...
            /*
             * else if (line.toUpperCase().startsWith("H")) { encryptionType = "H"; }
             */
            else
            {
              encryptionType = "RC4";
           ...
           * UseProxyAuthentication = false; return false; } if (proxyPort != null && port
           * != null) { VTTerminal.
           ...
           * line; VTTerminal.print("VT>Enter the proxy password:"); line =
