...
public class VTClientRemoteGraphicalConsoleInputMenuBar extends MenuBar
{
	...
	private class VTClientGraphicalConsoleFlushInterruptedNotify implements VTConsoleBooleanToggleNotify
	{
	...
	private class VTClientGraphicalConsoleReplaceInputNotify implements VTConsoleBooleanToggleNotify
	{
		public void notify(boolean state)
		{
			replaceInput = state;
	...
	public VTClientRemoteGraphicalConsoleInputMenuBar(final VTClientConfigurationDialog connectionDialog)
	{
		...
		serverStandarScreenCaptureMenu.add(new VTGraphicalConsoleInputMenuItem("Worst Color Quality", "*VTSCREENSHOT PW "));
		serverStandarScreenCaptureMenu.add(new VTGraphicalConsoleInputMenuItem("Low Color Quality", "*VTSCREENSHOT PL "));
		...
		serverStandarScreenCaptureMenu.add(new VTGraphicalConsoleInputMenuItem("Medium Color Quality", "*VTSCREENSHOT PM "));
		...
		serverStandarScreenCaptureMenu.add(new VTGraphicalConsoleInputMenuItem("High Color Quality", "*VTSCREENSHOT PH "));
		serverStandarScreenCaptureMenu.add(new VTGraphicalConsoleInputMenuItem("Best Color Quality", "*VTSCREENSHOT PB "));
		...
		serverConnectionSettingsMenu.add(new VTGraphicalConsoleInputMenuItem("Set Connection Login", "*VTLOCK "));
		...
		serverSOCKSTunnelsMenu.add(new VTGraphicalConsoleInputMenuItem("List All SOCKS Tunnels", "*VTSOCKSTUNNEL\n"));
		serverSOCKSTunnelsMenu.add(new VTGraphicalConsoleInputMenuItem("Set Local To Remote", "*VTSOCKSTUNNEL L "));
		serverSOCKSTunnelsMenu.add(new VTGraphicalConsoleInputMenuItem("Set Remote To Local", "*VTSOCKSTUNNEL R "));
		serverSOCKSTunnelsMenu.add(new VTGraphicalConsoleInputMenuItem("Command Usage", "*VTHELP *VTSOCKSTUNNEL\n"));
...
//				VTGlobalTextStyleManager.packComponents();
	...
	{
		VTConsole.addToggleFlushInterruptNotify(new VTClientGraphicalConsoleFlushInterruptedNotify());
		VTConsole.addToggleReplaceInputNotify(new VTClientGraphicalConsoleReplaceInputNotify());
	}
