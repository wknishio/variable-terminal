package org.vate.server.dialog;
...
public class VTServerConnectionDialog extends Dialog
{
	private static final long serialVersionUID = 1L;
	
	private VTServerConnectionDialogParameter connectionMode;
	private VTServerConnectionDialogParameter connectionHost;
	private VTServerConnectionDialogParameter connectionPort;
	private VTServerConnectionDialogParameter authenticationLogin;
	private VTServerConnectionDialogParameter authenticationPassword;
	private VTServerConnectionDialogParameter natPort;
	private VTServerConnectionDialogParameter proxyType;
	private VTServerConnectionDialogParameter proxyHost;
	private VTServerConnectionDialogParameter proxyPort;
	private VTServerConnectionDialogParameter proxySecurity;
	private VTServerConnectionDialogParameter proxyUser;
	private VTServerConnectionDialogParameter proxyPassword;
	private VTServerConnectionDialogParameter encryptionType;
	private VTServerConnectionDialogParameter encryptionPassword;
	
	private VTServerConnectionDialogParameter sessionsLimit;
	private Runnable application;
	private Frame owner;
	//private volatile boolean opened;
	// private Button okButton;
	
	public VTServerConnectionDialog(Frame owner, String title, boolean modal, Runnable application)
	{
	...
	public VTServerConnectionDialog(Frame owner, String title, boolean modal, GraphicsConfiguration gc, final Runnable application)
	{
		...
		connectionMode = new VTServerConnectionDialogParameter("Connection Mode:", connectionModeChoice, true);
		TextField connectionHostField = new TextField(20);
		connectionHost = new VTServerConnectionDialogParameter("Connection Host:", connectionHostField, true);
		...
		connectionPort = new VTServerConnectionDialogParameter("Connection Port:", connectionPortField, true);
		...
		natPort = new VTServerConnectionDialogParameter("Connection NAT Port:", natPortField, false);
		Choice proxyTypeChoice = new Choice();
		proxyType = new VTServerConnectionDialogParameter("Proxy Type:", proxyTypeChoice, true);
		TextField proxyHostField = new TextField(20);
		proxyHost = new VTServerConnectionDialogParameter("Proxy Host:", proxyHostField, false);
		...
		proxyPort = new VTServerConnectionDialogParameter("Proxy Port:", proxyPortField, false);
		Choice proxySecurityChoice = new Choice();
		proxySecurity = new VTServerConnectionDialogParameter("Proxy Authentication:", proxySecurityChoice, false);
		TextField proxyUserField = new TextField(20);
		proxyUserField.setEchoChar('*');
		proxyUser = new VTServerConnectionDialogParameter("Proxy User:", proxyUserField, false);
		TextField proxyPasswordField = new TextField(20);
		proxyPasswordField.setEchoChar('*');
		proxyPassword = new VTServerConnectionDialogParameter("Proxy Password:", proxyPasswordField, false);
		Choice encryptionTypeChoice = new Choice();
		encryptionType = new VTServerConnectionDialogParameter("Encryption Type:", encryptionTypeChoice, true);
		TextField encryptionPasswordField = new TextField(20);
		encryptionPasswordField.setEchoChar('*');
		encryptionPassword = new VTServerConnectionDialogParameter("Encryption Password:", encryptionPasswordField, false);
		...
		TextField sessionsLimitField = new TextField(20);
		...
		sessionsLimit = new VTServerConnectionDialogParameter("Sessions Limit:", sessionsLimitField, true);
		
		TextField connectionLoginField = new TextField(20);
		connectionLoginField.setEchoChar('*');
		authenticationLogin = new VTServerConnectionDialogParameter("Authentication Login:", connectionLoginField, true);
		
		TextField connectionPasswordField = new TextField(20);
		connectionPasswordField.setEchoChar('*');
		authenticationPassword = new VTServerConnectionDialogParameter("Authentication Password:", connectionPasswordField, true);
		...
		loadButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				loadFileDialog.setFile("variable-terminal-server.properties");
		...
		saveButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				saveFileDialog.setFile("variable-terminal-server.properties");
