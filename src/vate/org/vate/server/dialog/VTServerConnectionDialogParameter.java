...
public class VTServerConnectionDialogParameter extends Panel
{
	private static final long serialVersionUID = 1L;
	private Label label;
	private Component parameter;
	
	public VTServerConnectionDialogParameter(String label, Component parameter, boolean enabled)
	{
		...
		add(this.parameter, BorderLayout.CENTER);
		setEnabled(enabled);
	}
