package org.vate.server.screenshot;
...
public class VTServerScreenshotTask extends VTTask
{
	...
	public void run()
	{
		try
		{
			...
			photoOutputStream = new VTBufferedOutputStream(Channels.newOutputStream(new FileOutputStream(screenshotFile).getChannel()), 1024 * 32);
			 ...
			 * this.session.getServer().getRuntime().availableProcessors());
			 * screenCapture =
