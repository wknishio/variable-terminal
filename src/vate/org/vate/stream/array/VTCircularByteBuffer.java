 ...
 */
public class VTCircularByteBuffer {
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	protected InputStream in = new VTCircularByteBufferInputStream();
	/**
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	protected OutputStream out = new VTCircularByteBufferOutputStream();
	/**
	 ...
	 * without bound.
	 *
	 * @param size desired capacity of the buffer in bytes or VTCircularByteBuffer.INFINITE_SIZE.
	 *
	 * @since ostermillerutils 1.00.00
	 */
		 ...
		 public int read() throws IOException {
			while (true){
				synchronized (VTCircularByteBuffer.this){
					...
					int available = VTCircularByteBuffer.this.available();
					if (available > 0){
	 ...
	 * based on the VTCircularByteBuffer's preference.
	 *
	 * @since ostermillerutils 1.00.00
	 */
