...
public class VTZipUtils
{
	...
	{
		System.out.println(SAWZipUtils.createZipFile("zip-test.zip", -1, new byte[64 * 1024],"dist"));
		System.out.println(SAWZipUtils.extractZipFile("zip-test.zip", new byte[64 * 1024],"aua"));
	}*/
}