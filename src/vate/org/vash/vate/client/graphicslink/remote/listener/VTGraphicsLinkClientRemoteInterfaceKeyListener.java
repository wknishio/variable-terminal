...
public class VTGraphicsLinkClientRemoteInterfaceKeyListener implements KeyListener
{
  ...
  public VTGraphicsLinkClientRemoteInterfaceKeyListener(VTGraphicsLinkClientWriter writer)
  {
    this.writer = writer;
