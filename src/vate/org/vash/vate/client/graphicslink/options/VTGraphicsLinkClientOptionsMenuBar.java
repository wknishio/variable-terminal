...
public class VTGraphicsLinkClientOptionsMenuBar extends MenuBar
{
  ...
  private VTGraphicsLinkClientOptionsMenuBarControlMenu controlMenu;
  ...
  public VTGraphicsLinkClientOptionsMenuBar(VTGraphicsLinkClientWriter writer, Frame frame)
  {
    ...
    this.viewMenu = new VTGraphicsLinkClientOptionsMenuBarViewMenu(writer);
    this.controlMenu = new VTGraphicsLinkClientOptionsMenuBarControlMenu(writer, keyboardShortcutsMenu);
