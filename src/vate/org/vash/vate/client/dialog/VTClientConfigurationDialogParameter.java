...
public class VTClientConfigurationDialogParameter extends Panel
{
  private static final long serialVersionUID = 1L;
  private Label label;
  private Component parameter;
  
  public VTClientConfigurationDialogParameter(String label, Component parameter, boolean enabled)
  {
