...
//		serverCleanScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Best Color Quality", "*VTSCREENSHOT CB "));
    ...
    serverPointerScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("True Color Quality", "*VTSCREENSHOT DT "));
    serverPointerScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Ultra Color Quality", "*VTSCREENSHOT DU "));
    serverPointerScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("High Color Quality", "*VTSCREENSHOT DH "));
    serverPointerScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Extra Color Quality", "*VTSCREENSHOT DE "));
    serverPointerScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Next Color Quality", "*VTSCREENSHOT DN "));
    serverPointerScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Medium Color Quality", "*VTSCREENSHOT DM "));
    serverPointerScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Simple Color Quality", "*VTSCREENSHOT DS "));
    serverPointerScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Few Color Quality", "*VTSCREENSHOT DF "));
    serverPointerScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Low Color Quality", "*VTSCREENSHOT DL "));
    serverPointerScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Gray Color Quality", "*VTSCREENSHOT DG "));
    serverPointerScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Worst Color Quality", "*VTSCREENSHOT DW "));
    
    serverCleanScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("True Color Quality", "*VTSCREENSHOT CT "));
    serverCleanScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Ultra Color Quality", "*VTSCREENSHOT CU "));
    serverCleanScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("High Color Quality", "*VTSCREENSHOT CH "));
    serverCleanScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Extra Color Quality", "*VTSCREENSHOT CE "));
    serverCleanScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Next Color Quality", "*VTSCREENSHOT CN "));
    serverCleanScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Medium Color Quality", "*VTSCREENSHOT CM "));
    serverCleanScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Simple Color Quality", "*VTSCREENSHOT CS "));
    serverCleanScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Few Color Quality", "*VTSCREENSHOT CF "));
    serverCleanScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Low Color Quality", "*VTSCREENSHOT CL "));
    serverCleanScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Gray Color Quality", "*VTSCREENSHOT CG "));
    serverCleanScreenCaptureMenu.add(new VTGraphicalConsoleMenuItem("Worst Color Quality", "*VTSCREENSHOT CW "));
