...
public class VTScrollPaneAdjustable implements Adjustable, Serializable
{
  public VTScrollPaneAdjustable(ScrollPane sp, AdjustmentListener l, int orientation)
  {
    this.sp = sp;
