...
public class VTPROPERTY extends VTServerStandardLocalConsoleCommandProcessor
{
  ...
  public void execute(String command, String[] parsed) throws Exception
  {
    ...
    else if (parsed.length == 2)
    {
      ...
      {
        VTMainConsole.print("\rVT>Java property [" + parsed[1] + "] not found on server!\nVT>");
      }
    }
    else if (parsed.length >= 3)
    {
      ...
      {
        VTMainConsole.print("\rVT>Java property [" + parsed[1] + "] failed to be set to [" + parsed[2] + "] on server!\nVT>");
      }
    }
    else
    {
