      ...
      if (parsed[1].equalsIgnoreCase("SF"))
      {
        if (parsed.length == 2)
        {
          try
          {
            ...
            VTMainConsole.print("\rVT>Saved settings file:[vate-server.properties]\nVT>");
          }
          catch (Throwable t)
          {
            VTMainConsole.print("\rVT>Failed to save settings file:[vate-server.properties]\nVT>");
          }
        }
        else if (parsed.length >= 3)
        {
          try
          {
            ...
            VTMainConsole.print("\rVT>Saved settings file:[" + parsed[2] + "]\nVT>");
          }
          catch (Throwable t)
          {
            VTMainConsole.print("\rVT>Failed to save settings file:[" + parsed[2] + "]\nVT>");
          }
        }
        else
        {
      ...
      else if (parsed[1].equalsIgnoreCase("LF"))
      {
        if (parsed.length == 2)
        {
          ...
          try
          {
            ...
            VTMainConsole.print("\rVT>Loaded settings file:[vate-server.properties]\nVT>");
            ok = true;
          }
          catch (Throwable t)
          {
            VTMainConsole.print("\rVT>Failed to load settings file:[vate-server.properties]\nVT>");
          }
          if (ok)
          {
        ...
        else if (parsed.length >= 3)
        {
          ...
          try
          {
            ...
            VTMainConsole.print("\rVT>Loaded settings file:[" + parsed[2] + "]\nVT>");
            ok = true;
          }
          catch (Throwable t)
          {
            VTMainConsole.print("\rVT>Failed to load settings file:[" + parsed[2] + "]\nVT>");
          }
          if (ok)
          {
            VTServerConnector connector = server.getServerConnector();
...
//      }
      else if (parsed[1].equalsIgnoreCase("SM"))
      {
        ...
        {
          Integer sessionsMaximum = server.getServerConnector().getSessionsMaximum();
          VTMainConsole.print("\rVT>Session maximum(SM): [" + (sessionsMaximum == null ? "" : sessionsMaximum) + "]\nVT>");
        }
        else if (parsed.length >= 3)
        {
          ...
          VTMainConsole.print("\rVT>Session maximum(SM) set to: [" + (sessionsMaximum == null ? "" : sessionsMaximum) + "]\nVT>");
        }
        else
        {
          VTMainConsole.print("\rVT>Invalid command syntax!" + VTHelpManager.getHelpForServerCommand(parsed[0]));
      ...
      else if (parsed[1].equalsIgnoreCase("CM"))
      {
        if (parsed.length == 2)
        {
          if (server.getServerConnector().isPassive())
          {
            VTMainConsole.print("\rVT>Connection mode(CM): [Passive]\nVT>");
          }
          else
          {
            VTMainConsole.print("\rVT>Connection mode(CM): [Active]\nVT>");
          }
        }
        else if (parsed.length >= 3)
        {
          ...
          VTMainConsole.print("\rVT>Connection mode(CM) set to: [" + (passive ? "Passive" : "Active") + "]\nVT>");
        }
        else
        {
          VTMainConsole.print("\rVT>Invalid command syntax!" + VTHelpManager.getHelpForServerCommand(parsed[0]));
      ...
      else if (parsed[1].equalsIgnoreCase("CH"))
      {
        ...
        {
          String hostAddress = server.getServerConnector().getAddress();
          VTMainConsole.print("\rVT>Connection host address(CH): [" + hostAddress + "]\nVT>");
        }
        else if (parsed.length >= 3)
        {
          ...
          VTMainConsole.print("\rVT>Connection host address(CH) set to: [" + hostAddress + "]\nVT>");
        }
        else
        {
          VTMainConsole.print("\rVT>Invalid command syntax!" + VTHelpManager.getHelpForServerCommand(parsed[0]));
      ...
      else if (parsed[1].equalsIgnoreCase("CP"))
      {
        ...
        {
          Integer port = server.getServerConnector().getPort();
          VTMainConsole.print("\rVT>Connection host port(CP): [" + port + "]\nVT>");
        }
        else if (parsed.length >= 3)
        {
          try
          {
            ...
            else
            {
              ...
              VTMainConsole.print("\rVT>Connection host port(CP) set to: [" + port + "]\nVT>");
            }
          }
      ...
      else if (parsed[1].equalsIgnoreCase("PT"))
      {
        if (parsed.length == 2)
        {
          ...
          if (proxyType == null)
          {
            VTMainConsole.print("\rVT>Proxy type(PT): []\nVT>");
          }
          else if (proxyType.toUpperCase().startsWith("H"))
          {
            VTMainConsole.print("\rVT>Proxy type(PT): [HTTP]\nVT>");
          }
          else if (proxyType.toUpperCase().startsWith("S"))
          {
            VTMainConsole.print("\rVT>Proxy type(PT): [SOCKS]\nVT>");
          }
          else if (proxyType.toUpperCase().startsWith("P"))
          {
            VTMainConsole.print("\rVT>Proxy type(PT): [PLUS]\nVT>");
          }
          else
          {
            VTMainConsole.print("\rVT>Proxy type(PT): []\nVT>");
        ...
        else if (parsed.length >= 3)
        {
          ...
          {
            VTMainConsole.print("\rVT>Proxy type(PT) set to: [HTTP]\nVT>");
          }
          else if (proxyType.toUpperCase().startsWith("S"))
          {
            VTMainConsole.print("\rVT>Proxy type(PT) set to: [SOCKS]\nVT>");
          }
          else if (proxyType.toUpperCase().startsWith("P"))
          {
            VTMainConsole.print("\rVT>Proxy type(PT) set to: [PLUS]\nVT>");
          }
          else
          {
            VTMainConsole.print("\rVT>Proxy type(PT) set to: []\nVT>");
          }
        }
        else
        {
      ...
      else if (parsed[1].equalsIgnoreCase("PH"))
      {
        ...
        {
          String proxyAddress = server.getServerConnector().getProxyAddress();
          VTMainConsole.print("\rVT>Proxy host address(PH): [" + proxyAddress + "]\nVT>");
        }
        else if (parsed.length >= 3)
        {
          ...
          VTMainConsole.print("\rVT>Proxy host address set to: [" + proxyAddress + "]\nVT>");
        }
        else
        {
          VTMainConsole.print("\rVT>Invalid command syntax!" + VTHelpManager.getHelpForServerCommand(parsed[0]));
      ...
      else if (parsed[1].equalsIgnoreCase("PP"))
      {
        if (parsed.length == 2)
        {
          ...
          if (proxyPort != null)
          {
            VTMainConsole.print("\rVT>Proxy host port(PP): [" + proxyPort + "]\nVT>");
          }
          else
          {
            VTMainConsole.print("\rVT>Proxy host port(PP): []\nVT>");
          }
        }
        else if (parsed.length >= 3)
        {
          try
          {
            ...
            else
            {
              ...
              VTMainConsole.print("\rVT>Proxy host port(PP) set to: [" + proxyPort + "]\nVT>");
            }
          }
          catch (NumberFormatException e)
          {
...
//      }
      else if (parsed[1].equalsIgnoreCase("PU"))
      {
        ...
        {
          String proxyUser = server.getServerConnector().getProxyUser();
          VTMainConsole.print("\rVT>Proxy user(PU): [" + proxyUser + "]\nVT>");
        }
        else if (parsed.length >= 3)
        {
          ...
          VTMainConsole.print("\rVT>Proxy user(PU) set to: [" + proxyUser + "]\nVT>");
        }
        else
        {
          VTMainConsole.print("\rVT>Invalid command syntax!" + VTHelpManager.getHelpForServerCommand(parsed[0]));
      ...
      else if (parsed[1].equalsIgnoreCase("PK"))
      {
        ...
        {
          String proxyPassword = server.getServerConnector().getProxyPassword();
          VTMainConsole.print("\rVT>Proxy password(PK): [" + proxyPassword + "]\nVT>");
        }
        else if (parsed.length >= 3)
        {
...
//          }
      ...
      else if (parsed[1].equalsIgnoreCase("EK"))
      {
        if (parsed.length == 2)
        {
          ...
          VTMainConsole.print("\rVT>Encryption password(EK): [" + encryptionPassword + "]\nVT>");
        }
        else if (parsed.length >= 3)
        {
          ...
          VTMainConsole.print("\rVT>Encryption password(EK) set to: [" + encryptionPassword + "]\nVT>");
        }
        else
        {
          VTMainConsole.print("\rVT>Invalid command syntax!" + VTHelpManager.getHelpForServerCommand(parsed[0]));
      ...
      else if (parsed[1].equalsIgnoreCase("CN"))
      {
        if (parsed.length == 2)
        {
          ...
          if (natPort != null)
          {
            VTMainConsole.print("\rVT>Connection nat port(CN): [" + natPort + "]\nVT>");
          }
          else
          {
            VTMainConsole.print("\rVT>Connection nat port(CN): []\nVT>");
          }
        }
        else if (parsed.length >= 3)
        {
          try
          {
            ...
            else
            {
              ...
              if (natPort == 0)
              {
                ...
                VTMainConsole.print("\rVT>Connection nat port(CN) set to: []\nVT>");
              }
              else
              {
                synchronized (connector)
                ...
                VTMainConsole.print("\rVT>Connection nat port(CN) set to: [" + natPort + "]\nVT>");
              }
            }
          }
          catch (NumberFormatException e)
      ...
      else if (parsed[1].equalsIgnoreCase("SS"))
      {
        ...
        {
          String sessionShell = server.getServerConnector().getSessionShell();
          VTMainConsole.print("\rVT>Session shell(SS): [" + sessionShell + "]\nVT>");
        }
        else if (parsed.length >= 3)
        {
          ...
          VTMainConsole.print("\rVT>Session shell(SS) set to: [" + sessionShell + "]\nVT>");
        }
        else
        {
          VTMainConsole.print("\rVT>Invalid command syntax!" + VTHelpManager.getHelpForServerCommand(parsed[0]));
      ...
      else if (parsed[1].equalsIgnoreCase("SA"))
      {
        if (parsed.length >= 3)
        {
          ...
          {
            VTMainConsole.print("\rVT>Session accounts(SA) set to: [" + sessionUsers + "]\nVT>");
          }
          else
          {
            VTMainConsole.print("\rVT>Session accounts(SA) set to: []\nVT>");
          }
        }
        else
        {
      ...
      else if (parsed[1].equalsIgnoreCase("PL"))
      {
        ...
        {
          String pingLimit = (server.getPingLimit() > 0 ? "" + server.getPingLimit() : "");
          VTMainConsole.print("\rVT>Ping limit(PL): [" + pingLimit + "]\nVT>");
        }
        else if (parsed.length >= 3)
        {
          try
          {
            ...
            if (pingLimit > 0)
            {
              ...
              VTMainConsole.print("\rVT>Ping limit(PL) set to: [" + (server.getPingLimit() > 0 ? server.getPingLimit() : "") + "]\nVT>");
            }
            else
            {
      ...
      else if (parsed[1].equalsIgnoreCase("PI"))
      {
        ...
        {
          String pingInterval = (server.getPingInterval() > 0 ? "" + server.getPingInterval() : "");
          VTMainConsole.print("\rVT>Ping interval(PI): [" + pingInterval + "]\nVT>");
        }
        else if (parsed.length >= 3)
        {
          try
          {
            ...
            if (pingInterval > 0)
            {
              ...
              VTMainConsole.print("\rVT>Ping interval(PI) set to: [" + (server.getPingInterval() > 0 ? server.getPingInterval() : "") + "]\nVT>");
            }
            else
            {
