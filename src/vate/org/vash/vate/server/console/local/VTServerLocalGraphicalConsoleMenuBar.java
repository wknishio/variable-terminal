...
public class VTServerLocalGraphicalConsoleMenuBar extends VTGraphicalConsoleMenuBar
{
  ...
  public VTServerLocalGraphicalConsoleMenuBar(final VTServerSettingsDialog connectionDialog)
  {
    ...
    serverConnectionMenu.add(new VTGraphicalConsoleMenuItem("Set Connection Mode", "*VTSETTINGS CM "));
    serverConnectionMenu.add(new VTGraphicalConsoleMenuItem("Set Connection Host", "*VTSETTINGS CH "));
    serverConnectionMenu.add(new VTGraphicalConsoleMenuItem("Set Connection Port", "*VTSETTINGS CP "));
    serverConnectionMenu.add(new VTGraphicalConsoleMenuItem("Set Connection NAT Port", "*VTSETTINGS NP "));
    serverProxyMenu.add(new VTGraphicalConsoleMenuItem("Set Proxy Type", "*VTSETTINGS PT "));
    serverProxyMenu.add(new VTGraphicalConsoleMenuItem("Set Proxy Host", "*VTSETTINGS PH "));
    serverProxyMenu.add(new VTGraphicalConsoleMenuItem("Set Proxy Port", "*VTSETTINGS PP "));
    serverProxyMenu.add(new VTGraphicalConsoleMenuItem("Set Proxy Authentication", "*VTSETTINGS PA "));
    serverProxyMenu.add(new VTGraphicalConsoleMenuItem("Set Proxy User", "*VTSETTINGS PU "));
    serverProxyMenu.add(new VTGraphicalConsoleMenuItem("Set Proxy Password", "*VTSETTINGS PK "));
    serverEncryptionMenu.add(new VTGraphicalConsoleMenuItem("Set Encryption Type", "*VTSETTINGS ET "));
    serverEncryptionMenu.add(new VTGraphicalConsoleMenuItem("Set Encryption Password", "*VTSETTINGS EK "));
    serverSessionsMenu.add(new VTGraphicalConsoleMenuItem("Set Session Maximum", "*VTSETTINGS SM "));
