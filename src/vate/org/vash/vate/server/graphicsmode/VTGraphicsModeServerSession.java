...
public class VTGraphicsModeServerSession
{
  ...
  public boolean verifySession()
  {
    ...
    try
    {
      viewProviderInitialized = session.getViewProvider().isScreenCaptureInitialized(VTQuadrupleOctalTreeFrameDifferenceCodecMKII.PADDING_SIZE) || session.getViewProvider().initializeScreenCapture(VTQuadrupleOctalTreeFrameDifferenceCodecMKII.PADDING_SIZE);
