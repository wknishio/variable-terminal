...
public class VTBlake3HalfMessageDigest extends MessageDigest
{
  // private static final Blake3Digest BLAKE3 = new Blake3Digest();
  private final VTBlake3HalfDigest blake3 = new VTBlake3HalfDigest(64);
  
  public VTBlake3HalfMessageDigest()
  {
    super("BLAKE3HALF");
    //this.blake3.init(null);
  }
  
  public VTBlake3HalfMessageDigest(final byte[] seed)
  {
    super("BLAKE3HALF");
    setSeed(seed);
  }
