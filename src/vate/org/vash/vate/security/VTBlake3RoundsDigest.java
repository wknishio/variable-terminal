...
import org.bouncycastlevt.crypto.ExtendedDigest;
import org.bouncycastlevt.crypto.Xof;
import org.bouncycastlevt.crypto.params.Blake3Parameters;
import org.bouncycastlevt.util.Arrays;
import org.bouncycastlevt.util.Integers;
import org.bouncycastlevt.util.Memoable;
    ...
    implements ExtendedDigest, Memoable, Xof
{
     ...
     * The chainingStack.
     */
    private final Stack<int[]> theStack = new Stack<int[]>();
    ...
    public void reset(final Memoable pSource)
    {
        ...
        /* Copy stack */
        theStack.clear();
        for (Iterator<int[]> it = mySource.theStack.iterator(); it.hasNext(); )
        {
            theStack.push(Arrays.clone(it.next()));
        }
