    ...
    implements ExtendedDigest, Memoable, Xof
{
     ...
     */
    public VTBlake3Digest(final int pDigestLen)
    {
     ...
     */
    public VTBlake3Digest(final VTBlake3Digest pSource)
    {
    ...
    {
        /* Access source */
        final VTBlake3Digest mySource = (VTBlake3Digest)pSource;
    ...
    {
        return new VTBlake3Digest(this);
    }
