...
import vate.org.apache.commons.logging.impl.NoOpLog;
 ...
 *     <code>vate.org.apache.commons.logging.impl.NoOpLog</code>.</li>
 * </ul>
 *
 * <p>You can change the default behavior in one of two ways:</p>
 * <ul>
 * <li>On the startup command line, set the system property
 *     <code>vate.org.apache.commons.logging.log</code> to the name of the
 *     <code>vate.org.apache.commons.logging.Log</code> implementation class
 *     you want to use.</li>
...
public class LogSource {
    ...
    static {
        ...
        try {
            if ((null != Class.forName("java.util.logging.Logger")) &&
                (null != Class.forName("vate.org.apache.commons.logging.impl.Jdk14Logger"))) {
        ...
        String name = null;
        try {
            name = System.getProperty("vate.org.apache.commons.logging.log");
            if (name == null) {
                name = System.getProperty("vate.org.apache.commons.logging.Log");
            }
        } catch (Throwable t) {
        ...
        if (name != null) {
            try {
                ...
                try {
                    setLogImplementation
                            ("vate.org.apache.commons.logging.impl.NoOpLog");
                } catch (Throwable u) {
                    ;
                }
            }
            ...
            try {
                if (log4jIsAvailable) {
                    setLogImplementation
                            ("vate.org.apache.commons.logging.impl.Log4JLogger");
     ...
     * <tt>vate.org.apache.commons.logging.log</tt> property.
     * The value of <tt>vate.org.apache.commons.logging.log</tt> may be set to
     ...
     * <p>
     * When <tt>vate.org.apache.commons.logging.log</tt> is not set,
