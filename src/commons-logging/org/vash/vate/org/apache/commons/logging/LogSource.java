...
import org.vash.vate.org.apache.commons.logging.impl.NoOpLog;
 ...
 *     <code>org.vash.vate.org.apache.commons.logging.impl.NoOpLog</code>.</li>
 * </ul>
 *
 * <p>You can change the default behavior in one of two ways:</p>
 * <ul>
 * <li>On the startup command line, set the system property
 *     <code>org.vash.vate.org.apache.commons.logging.log</code> to the name of the
 *     <code>org.vash.vate.org.apache.commons.logging.Log</code> implementation class
 *     you want to use.</li>
...
public class LogSource {
    ...
    static {
        ...
        try {
            if ((null != Class.forName("java.util.logging.Logger")) &&
                (null != Class.forName("org.vash.vate.org.apache.commons.logging.impl.Jdk14Logger"))) {
        ...
        String name = null;
        try {
            name = System.getProperty("org.vash.vate.org.apache.commons.logging.log");
            if (name == null) {
                name = System.getProperty("org.vash.vate.org.apache.commons.logging.Log");
            }
        } catch (Throwable t) {
        ...
        if (name != null) {
            try {
                ...
                try {
                    setLogImplementation
                            ("org.vash.vate.org.apache.commons.logging.impl.NoOpLog");
                } catch (Throwable u) {
                    ;
                }
            }
            ...
            try {
                if (log4jIsAvailable) {
                    setLogImplementation
                            ("org.vash.vate.org.apache.commons.logging.impl.Log4JLogger");
     ...
     * <tt>org.vash.vate.org.apache.commons.logging.log</tt> property.
     * The value of <tt>org.vash.vate.org.apache.commons.logging.log</tt> may be set to
     ...
     * <p>
     * When <tt>org.vash.vate.org.apache.commons.logging.log</tt> is not set,
