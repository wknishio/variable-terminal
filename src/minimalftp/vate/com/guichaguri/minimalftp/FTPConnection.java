...
package vate.com.guichaguri.minimalftp;
...
import vate.com.guichaguri.minimalftp.api.CommandInfo;
import vate.com.guichaguri.minimalftp.api.IFileSystem;
import vate.com.guichaguri.minimalftp.api.IUserAuthenticator;
import vate.com.guichaguri.minimalftp.api.ResponseException;
import vate.com.guichaguri.minimalftp.api.CommandInfo.Command;
import vate.com.guichaguri.minimalftp.handler.FTPConnectionHandler;
import vate.com.guichaguri.minimalftp.handler.FTPFileHandler;
...
public class FTPConnection implements Closeable {
    ...
    protected FTPFileHandler fileHandler;
    ...
    public FTPConnection(FTPServer server, Socket con, int idleTimeout, int bufferSize) throws IOException {
        ...
        registerCommand("SITE", "SITE <command>", site());
        registerCommand("FEAT", "FEAT", feat(), false);
        registerCommand("OPTS", "OPTS <option> [value]", opts());
    ...
    public void start() throws IOException
    {
      ...
      this.fileHandler = new FTPFileHandler(this);
    ...
    public FTPConnection(FTPServer server, Socket con, int idleTimeout) throws IOException {
        this(server, con, idleTimeout, 1024 * 8);
    }
...
//    }
     ...
     */
    public void registerFeature(String... feats) {
     ...
     * @param feat
     */
    public void unregisterFeature(String... feats) {
      for (String feat : feats)
      {
...
//    }
     ...
     */
    protected Command opts()
    {
      return new Command()
      {
        public void run(String parms) throws IOException {
          String[] opts = parms.split("\\s+");
          if(opts.length < 1) {
