...
package org.vash.vate.com.guichaguri.minimalftp.api;
 ...
 * @param <F>
 */
public interface IUserAuthenticator<F> {
     ...
     */
    boolean acceptsHost(FTPConnection con, InetAddress host);
     ...
     */
    IFileSystem<F> authenticate(FTPConnection con, InetAddress host, String username, String password) throws AuthException;
