...
import org.vash.vate.com.googlecode.lanterna.terminal.ansi.CygwinTerminal;
import org.vash.vate.com.googlecode.lanterna.terminal.ansi.TelnetTerminal;
import org.vash.vate.com.googlecode.lanterna.terminal.ansi.TelnetTerminalServer;
...
//        try {
//            Class<?> nativeImplementation = Class.forName("org.vash.vate.com.googlecode.lanterna.terminal.WindowsTerminal");
//            Constructor<?> constructor = nativeImplementation.getConstructor(InputStream.class, OutputStream.class, Charset.class, UnixLikeTTYTerminal.CtrlCBehaviour.class);
//            return (Terminal)constructor.newInstance(inputStream, outputStream, charset, UnixLikeTTYTerminal.CtrlCBehaviour.CTRL_C_KILLS_APPLICATION);
//        }
//        catch(Exception ignore) {
...
//        try {
//            Class<?> nativeImplementation = Class.forName("org.vash.vate.com.googlecode.lanterna.terminal.NativeGNULinuxTerminal");
//            Constructor<?> constructor = nativeImplementation.getConstructor(InputStream.class, OutputStream.class, Charset.class, UnixLikeTTYTerminal.CtrlCBehaviour.class);
