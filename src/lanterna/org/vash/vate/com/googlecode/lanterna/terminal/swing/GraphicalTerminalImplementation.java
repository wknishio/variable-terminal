...
import org.vash.vate.com.googlecode.lanterna.input.DefaultKeyDecodingProfile;
...
import org.vash.vate.com.googlecode.lanterna.terminal.virtual.DefaultVirtualTerminal;
import org.vash.vate.com.googlecode.lanterna.terminal.virtual.VirtualTerminal;
            ...
            public void onLine(int rowNumber, VirtualTerminal.BufferLine bufferLine) {
                for(int column = 0; column < viewportSize.getColumns(); column++) {
                    ...
                    if(dirtyCellsLookupTable.isAllDirty() || dirtyCellsLookupTable.isDirty(rowNumber, column) || isBlinking) {
                        ...
                        boolean drawCursor = atCursorLocation && cursorIsVisible &&
