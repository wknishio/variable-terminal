...
import vate.com.googlecode.lanterna.terminal.swing.GraphicalTerminalImplementation.TerminalMouseListener;
...
//        });
    ...
    public vate.com.googlecode.lanterna.input.KeyStroke readInput() {
        if(SwingUtilities.isEventDispatchThread()) {
