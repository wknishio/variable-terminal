 ...
 */
package vate.com.googlecode.lanterna.terminal.ansi;
...
public abstract class UnixLikeTerminal extends ANSITerminal {
    ...
    protected UnixLikeTerminal(InputStream terminalInput,
        ...
        String catchSpecialCharactersPropValue = System.getProperty(
                "vate.com.googlecode.lanterna.terminal.UnixTerminal.catchSpecialCharacters",
                "");
     ...
     * {@link vate.com.googlecode.lanterna.input.KeyStroke} instead of as a signal to the JVM process. For example,
     * <i>ctrl+c</i> will normally send an interrupt that causes the JVM to shut down, but this method will make it pass
     * in <i>ctrl+c</i> as a regular {@link vate.com.googlecode.lanterna.input.KeyStroke} instead. You can of course still
     ...
     * property "vate.com.googlecode.lanterna.terminal.UnixTerminal.catchSpecialCharacters" and set it to the string "false".
