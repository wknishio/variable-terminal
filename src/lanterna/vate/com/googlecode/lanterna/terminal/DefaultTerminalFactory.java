...
import vate.com.googlecode.lanterna.terminal.ansi.CygwinTerminal;
import vate.com.googlecode.lanterna.terminal.ansi.TelnetTerminal;
import vate.com.googlecode.lanterna.terminal.ansi.TelnetTerminalServer;
import vate.com.googlecode.lanterna.terminal.ansi.UnixLikeTTYTerminal;
import vate.com.googlecode.lanterna.terminal.ansi.UnixTerminal;
import vate.com.googlecode.lanterna.terminal.swing.*;
...
public class DefaultTerminalFactory implements TerminalFactory {
    ...
    private Terminal createWindowsTerminal() throws IOException {
        try {
            Class<?> nativeImplementation = Class.forName("vate.com.googlecode.lanterna.terminal.win32.WindowsTerminal");
...
//        try {
//            Class<?> nativeImplementation = Class.forName("vate.com.googlecode.lanterna.terminal.WindowsTerminal");
//            Constructor<?> constructor = nativeImplementation.getConstructor(InputStream.class, OutputStream.class, Charset.class, UnixLikeTTYTerminal.CtrlCBehaviour.class);
//            return (Terminal)constructor.newInstance(inputStream, outputStream, charset, UnixLikeTTYTerminal.CtrlCBehaviour.CTRL_C_KILLS_APPLICATION);
//        }
//        catch(Exception ignore) {
...
//        try {
//            Class<?> nativeImplementation = Class.forName("vate.com.googlecode.lanterna.terminal.NativeGNULinuxTerminal");
//            Constructor<?> constructor = nativeImplementation.getConstructor(InputStream.class, OutputStream.class, Charset.class, UnixLikeTTYTerminal.CtrlCBehaviour.class);
