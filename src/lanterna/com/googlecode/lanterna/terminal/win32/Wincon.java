...
public interface Wincon extends StdCallLibrary {
	...
	Wincon INSTANCE = Native.loadLibrary("kernel32", Wincon.class, W32APIOptions.UNICODE_OPTIONS);
    ...
    public static class MOUSE_EVENT_RECORD extends Structure {
		...
		private static final List<String> fieldOder = Arrays.asList((new String[] {"dwMousePosition", "dwButtonState", "dwControlKeyState", "dwEventFlags"}));
