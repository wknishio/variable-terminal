...
import com.googlecode.lanternavt.terminal.swing.GraphicalTerminalImplementation.TerminalMouseListener;
...
//        });
    ...
    public com.googlecode.lanternavt.input.KeyStroke readInput() {
        if(SwingUtilities.isEventDispatchThread()) {
