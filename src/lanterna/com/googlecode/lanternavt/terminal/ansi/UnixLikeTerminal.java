 ...
 */
package com.googlecode.lanternavt.terminal.ansi;
...
public abstract class UnixLikeTerminal extends ANSITerminal {
    ...
    protected UnixLikeTerminal(InputStream terminalInput,
        ...
        String catchSpecialCharactersPropValue = System.getProperty(
                "com.googlecode.lanternavt.terminal.UnixTerminal.catchSpecialCharacters",
                "");
     ...
     * {@link com.googlecode.lanternavt.input.KeyStroke} instead of as a signal to the JVM process. For example,
     * <i>ctrl+c</i> will normally send an interrupt that causes the JVM to shut down, but this method will make it pass
     * in <i>ctrl+c</i> as a regular {@link com.googlecode.lanternavt.input.KeyStroke} instead. You can of course still
     ...
     * property "com.googlecode.lanternavt.terminal.UnixTerminal.catchSpecialCharacters" and set it to the string "false".
