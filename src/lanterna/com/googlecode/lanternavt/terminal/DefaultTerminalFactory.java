...
import com.googlecode.lanternavt.terminal.ansi.CygwinTerminal;
import com.googlecode.lanternavt.terminal.ansi.TelnetTerminal;
import com.googlecode.lanternavt.terminal.ansi.TelnetTerminalServer;
import com.googlecode.lanternavt.terminal.ansi.UnixLikeTTYTerminal;
import com.googlecode.lanternavt.terminal.ansi.UnixTerminal;
import com.googlecode.lanternavt.terminal.swing.*;
...
public class DefaultTerminalFactory implements TerminalFactory {
    ...
    private Terminal createWindowsTerminal() throws IOException {
        try {
            Class<?> nativeImplementation = Class.forName("com.googlecode.lanternavt.terminal.win32.WindowsTerminal");
...
//        try {
//            Class<?> nativeImplementation = Class.forName("com.googlecode.lanternavt.terminal.WindowsTerminal");
//            Constructor<?> constructor = nativeImplementation.getConstructor(InputStream.class, OutputStream.class, Charset.class, UnixLikeTTYTerminal.CtrlCBehaviour.class);
//            return (Terminal)constructor.newInstance(inputStream, outputStream, charset, UnixLikeTTYTerminal.CtrlCBehaviour.CTRL_C_KILLS_APPLICATION);
//        }
//        catch(Exception ignore) {
...
//        try {
//            Class<?> nativeImplementation = Class.forName("com.googlecode.lanternavt.terminal.NativeGNULinuxTerminal");
//            Constructor<?> constructor = nativeImplementation.getConstructor(InputStream.class, OutputStream.class, Charset.class, UnixLikeTTYTerminal.CtrlCBehaviour.class);
