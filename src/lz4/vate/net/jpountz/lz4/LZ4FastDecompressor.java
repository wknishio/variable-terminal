 ...
 * Use {@link LZ4SafeDecompressor} if you only know the size of the compressed
 * stream.
 * <p>
...
public abstract class LZ4FastDecompressor implements LZ4Decompressor {
	 ...
	 * <code>dest[destOff:destOff+destLen]</code> and returns the number of bytes
	 * read from <code>src</code>. <code>destLen</code> must be exactly the size of
	 ...
	 * @param destLen
	 *            the <b>exact</b> size of the original input
	 ...
	 * <code>dest[destOff:destOff+destLen]</code> and returns the number of bytes
	 * read from <code>src</code>. <code>destLen</code> must be exactly the size of
	 * the decompressed data. The positions and limits of the {@link ByteBuffer}s
	 * remain unchanged.
	 *
	 * @param src
	 *            the compressed data
	 ...
	 * {@link #decompress(byte[], int, byte[], int, int) decompress(src, 0, dest, 0,
	 * destLen)}.
	 *
	 * @param src
	 *            the compressed data
	...
	/**
	 * Convenience method which returns <code>src[srcOff:?]</code> decompressed.
	 * <p>
