...
public final class XXHashFactory {
  ...
  private XXHashFactory(String impl) throws ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
    this.impl = impl;
    hash32 = classInstance("vate.net.jpountz.xxhash.XXHash32" + impl);
    streamingHash32Factory = classInstance("vate.net.jpountz.xxhash.StreamingXXHash32" + impl + "$Factory");
    hash64 = classInstance("vate.net.jpountz.xxhash.XXHash64" + impl);
    streamingHash64Factory = classInstance("vate.net.jpountz.xxhash.StreamingXXHash64" + impl + "$Factory");
