...
import org.vash.vate.net.jpountz.util.Native;
...
public final class XXHashFactory {
  ...
  public static synchronized XXHashFactory disabledInstance() {
	    if (JAVA_DISABLED_INSTANCE == null) {
	    	JAVA_DISABLED_INSTANCE = instance("JavaDisabled");
	    }
	    return JAVA_DISABLED_INSTANCE;
	  }
  ...
  private XXHashFactory(String impl) throws ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
    this.impl = impl;
    hash32 = classInstance("org.vash.vate.net.jpountz.xxhash.XXHash32" + impl);
    streamingHash32Factory = classInstance("org.vash.vate.net.jpountz.xxhash.StreamingXXHash32" + impl + "$Factory");
    hash64 = classInstance("org.vash.vate.net.jpountz.xxhash.XXHash64" + impl);
    streamingHash64Factory = classInstance("org.vash.vate.net.jpountz.xxhash.StreamingXXHash64" + impl + "$Factory");
