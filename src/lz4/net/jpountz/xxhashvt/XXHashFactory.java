...
public final class XXHashFactory {
  ...
  private XXHashFactory(String impl) throws ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
    this.impl = impl;
    hash32 = classInstance("net.jpountz.xxhashvt.XXHash32" + impl);
    streamingHash32Factory = classInstance("net.jpountz.xxhashvt.StreamingXXHash32" + impl + "$Factory");
    hash64 = classInstance("net.jpountz.xxhashvt.XXHash64" + impl);
    streamingHash64Factory = classInstance("net.jpountz.xxhashvt.StreamingXXHash64" + impl + "$Factory");
