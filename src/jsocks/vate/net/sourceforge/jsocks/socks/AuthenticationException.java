...
public class AuthenticationException extends Throwable {
	 ...
	 * 
	 * @param errorType
	 *            an enum denoting what kind of auth error.
	 */
	...
	/**
	 * Create an AuthenticationException with both the specified type and a
	 * free-form message
	 * 
	 * @param errorType
	 *            an enum denoting what kind of auth error.
	 * @param errorString
	 *            a specific string detailing the error.
	 */
	public AuthenticationException(AuthErrorType errorType, String errorString) {
		this.errorType = errorType;
	...
	public enum AuthErrorType {
		MALFORMED_REQUEST, PASSWORD_TOO_LONG;
	}
