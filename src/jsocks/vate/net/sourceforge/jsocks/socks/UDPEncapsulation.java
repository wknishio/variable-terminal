...
public interface UDPEncapsulation {
	 ...
	 *            encapsulate/encrypt data, otherwise it should decapsulate/ decrypt
	 *            data.
	 * @throw IOException if for some reason data can be transformed correctly.
	 * @return Should return byte array containing data after transformation. It is
	 *         possible to return same array as input, if transformation only
