...
import org.vash.vate.net.sourceforge.jsocks.socks.UDPEncapsulation;
...
public class ServerAuthenticatorNone implements ServerAuthenticator {
	...
	/**
	 * Constructs new ServerAuthenticatorNone object suitable for returning from the
	 ...
	 * written back to client, that this method have been chosen for authentication.
	 * If given method was not found, authentication failure message is send to
	 * client ([5,FF]).
	 * 
	 * @param in
	 ...
	 */
	static public boolean selectSocks5Authentication(InputStream in, OutputStream out, int methodId)
			throws IOException {
