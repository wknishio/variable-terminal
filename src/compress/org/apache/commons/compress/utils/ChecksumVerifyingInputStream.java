...
public class ChecksumVerifyingInputStream extends InputStream {
	...
	public ChecksumVerifyingInputStream(final Checksum checksum, final InputStream in, final long size,
	 ...
	 * 
	 * @throws IOException
	 *             if the underlying stream throws or the stream is exhausted and
