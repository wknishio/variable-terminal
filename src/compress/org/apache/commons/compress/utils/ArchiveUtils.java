...
public class ArchiveUtils {
	...
	/**
	 * Generates a string containing the name, isDirectory setting and size of an
	 * entry.
	 * <p>
	 * For example:
	 * 
	 ...
	 * need to be independent of the default Locale.
	 * 
	 * @param inputString
	 *            string to convert
	 * @return the bytes
	 ...
	 *            whether to ignore trailing nulls
	 * @return {@code true} if buffer1 and buffer2 have same contents, having regard
	 *         to trailing nulls
	 */
	public static boolean isEqual(final byte[] buffer1, final int offset1, final int length1, final byte[] buffer2,
			final int offset2, final int length2, boolean ignoreTrailingNulls) {
	 ...
	 *            the second buffer
	 * @param ignoreTrailingNulls
	 *            whether to ignore tariling nulls
	 * @return {@code true} if buffer1 and buffer2 have same contents
	 */
	 ...
	 *         to trailing nulls
	 */
	public static boolean isEqualWithNull(final byte[] buffer1, final int offset1, final int length1,
