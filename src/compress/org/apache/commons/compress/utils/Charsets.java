 ...
 *
 * <p>
 * This class best belongs in the Commons Lang or IO project. Even if a similar
 * class is defined in another Commons component, it is not foreseen that
 * Commons Compress would be made to depend on another Commons component.
 * </p>
 *
 * @see <a href=
 *      "http://docs.oracle.com/javase/6/docs/api/java/nio/charset/Charset.html">Standard
...
public class Charsets {
	...
	// guarantees that it will load correctly and
