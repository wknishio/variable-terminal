 ...
 * bytes the archive entries are listed. The format of an entry header is as it
 * follows:
 * 
 * <pre>
 ...
 * their own variants of this format. Currently Commons Compress can read but
 * not write the GNU variant. It fully supports the BSD variant.
 * 
...
public class ArArchiveEntry implements ArchiveEntry {
	...
	/**
	 * SVR4/GNU adds a trailing / to names; BSD does not. They also vary in how
	 * names longer than 16 characters are represented. (Not yet fully supported by
	 * this implementation)
	 */
	 ...
	 * 
	 * @param inputFile
	 *            the file to create an entry from
	 * @param entryName
	 *            the name of the entry
	 */
	public ArArchiveEntry(File inputFile, String entryName) {
		// TODO sort out mode
		this(entryName, inputFile.isFile() ? inputFile.length() : 0, 0, 0, DEFAULT_MODE,
