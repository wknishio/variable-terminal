...
public class CpioArchiveOutputStream extends ArchiveOutputStream implements CpioConstants {
	 ...
	 * {@link CpioConstants#BLOCK_SIZE BLOCK_SIZE} and using ASCII as the file name
	 * encoding.
	 * 
	 * @param out
	 *            The cpio stream
	...
	/**
	 * Construct the cpio output stream with a specified format using ASCII as the
	 * file name encoding.
	 * 
	 * @param out
	 *            The cpio stream
	 ...
	 *            The block size of the archive.
	 * @param encoding
	 *            The encoding of file names to write - use null for the platform's
	 *            default.
	 * 
	 * @since 1.6
	 */
	 ...
	 * the entry data. Closes the current entry if still active. The current time
	 * will be used if the entry has no set modification time and the default header
	 * format will be used if no other format is specified in the entry.
	 * 
	 * @param entry
	...
	public void closeArchiveEntry() throws IOException {
		...
		if (this.entry.getSize() != this.written) {
			throw new IOException(
					"invalid entry size (expected " + this.entry.getSize() + " but got " + this.written + " bytes)");
		}
	...
	/**
	 * Finishes writing the contents of the CPIO output stream without closing the
