...
abstract class CoderBase {
	...
	/**
	 * @return configuration options that have been used to create the given
	 *         InputStream from the given Coder
	 */
	 ...
	 */
	abstract InputStream decode(final String archiveName, final InputStream in, long uncomressedLength,
	...
	/**
	 * If the option represents a number, return its integer value, otherwise return
