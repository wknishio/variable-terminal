...
public class SevenZArchiveEntry implements ArchiveEntry {
	...
	/**
	 * Sets whether this is an "anti-item" used in differential backups, meaning it
	 * should delete the same file from a previous backup.
	 * 
	 * @param isAntiItem
	...
	/**
	 * Sets the creation date using NTFS time (100 nanosecond units since 1 January
	 * 1601)
	 * 
	 * @param ntfsCreationDate
	 *            the creation date
	 */
	...
	/**
	 * Sets the last modified date using NTFS time (100 nanosecond units since 1
	 * January 1601)
	 * 
	 * @param ntfsLastModifiedDate
	...
	/**
	 * Sets the access date using NTFS time (100 nanosecond units since 1 January
	 * 1601)
	 * 
	 * @param ntfsAccessDate
	 *            the access date
	 */
	...
	/**
	 * Sets the (compression) methods to use for entry's content - the default is
	 * LZMA2.
	 *
	 * <p>
	 * Currently only {@link SevenZMethod#COPY}, {@link SevenZMethod#LZMA2},
	 * {@link SevenZMethod#BZIP2} and {@link SevenZMethod#DEFLATE} are supported
	...
	/**
	 * Gets the (compression) methods to use for entry's content - the default is
	 * LZMA2.
	 *
	 * <p>
	 * Currently only {@link SevenZMethod#COPY}, {@link SevenZMethod#LZMA2},
