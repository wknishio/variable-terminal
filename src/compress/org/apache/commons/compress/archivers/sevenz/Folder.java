...
class Folder {
	 ...
	 * <p>
	 * The first coder reads from the packed stream (we currently only support
	 * single input stream decoders), the second reads from the output of the first
	 * and so on.
	 * </p>
	 */
	...
	public String toString() {
		return "Folder with " + coders.length + " coders, " + totalInputStreams + " input streams, "
				+ totalOutputStreams + " output streams, " + bindPairs.length + " bind pairs, " + packedStreams.length
