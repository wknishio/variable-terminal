...
class Coders {
	...
	static OutputStream addEncoder(final OutputStream out, final SevenZMethod method, Object options)
			throws IOException {
	...
	static class CopyDecoder extends CoderBase {
		...
		InputStream decode(final String archiveName, final InputStream in, long uncompressedLength, final Coder coder,
	...
	static class BCJDecoder extends CoderBase {
		...
		InputStream decode(final String archiveName, final InputStream in, long uncompressedLength, final Coder coder,
			...
			try {
				...
				IOException ex = new IOException("BCJ filter used in " + archiveName + " needs XZ for Java > 1.4 - see "
