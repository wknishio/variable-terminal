...
public class SevenZOutputFile implements Closeable {
	...
	private Iterable<? extends SevenZMethodConfiguration> contentMethods = Collections
	...
	/**
	 * Sets the default compression method to use for entry contents - the default
	 * is LZMA2.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * This is a short form for passing a single-element iterable to
	 * {@link #setContentMethods}.
	 * </p>
	 * 
	 * @param method
	 ...
	 *            The byte array to be written.
	 * @param off
	 *            offset into the array to start writing from
	 * @param len
	...
	/*
	 * Creation of output stream is deferred until data is actually written as some
	 * codecs might write header information even for empty streams and directories
	 * otherwise.
	 */
