 ...
 * was then dropped from PKZIP 2.0 released in 1993 in favor of the deflate
 * method.
 * <p>
...
class ExplodingInputStream extends InputStream {
	...
	/**
	 * The binary tree containing the 256 encoded literals (null when only two trees
	 * are used)
	 */
	...
	/**
	 * Create a new stream decompressing the content of the specified stream using
