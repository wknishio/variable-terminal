...
/**
 * Utility class that represents an eight byte integer with conversion rules for
...
public final class ZipEightByteInteger implements Serializable {
	...
	/**
	 * Helper method to get the value as a Java long from eight bytes starting at
	 * given array offset
	 * 
	 * @param bytes
	 *            the array of bytes
	...
	/**
	 * Helper method to get the value as a Java BigInteger from eight bytes starting
