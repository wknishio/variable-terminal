...
public final class GeneralPurposeBit implements Cloneable {
	...
	/**
	 * Indicates that a data descriptor stored after the file contents will hold CRC
	 ...
	 *
	 * <p>
	 * The only reason this is public is that
	 * {@link ZipArchiveOutputStream#EFS_FLAG} was public in Apache Commons Compress
	 * 1.0 and we needed a substitute for it.
	 * </p>
	 */
	 ...
	 * information.
	 * 
	 * @return whether the current entry uses the data descriptor to store CRC and
	 *         size information
	 */
	...
	/**
	 * whether the current entry will use the data descriptor to store CRC and size
	 * information.
	 * 
	 * @param b
	 ...
	 * 
	 * @param b
	 *            whether the current entry will be encrypted using strong
	 *            encryption
	 */
	...
	public int hashCode() {
		return 3 * (7 * (13 * (17 * (encryptionFlag ? 1 : 0) + (strongEncryptionFlag ? 1 : 0))
				+ (languageEncodingFlag ? 1 : 0)) + (dataDescriptorFlag ? 1 : 0));
	}
