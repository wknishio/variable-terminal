 ...
 * private to this class and are not part of any public api whatsoever.
 * </p>
 * <p>
 * It is possible to extend this class to support different kinds of backing
 * storage, the default implementation only supports file-based backing.
 * </p>
 * Thread safety: This class supports multiple threads. But the "writeTo" method
 * must be called by the thread that originally created the
...
public class ScatterZipOutputStream implements Closeable {
	...
	private static class CompressedEntry {
		...
		public CompressedEntry(ZipArchiveEntryRequest zipArchiveEntryRequest, long crc, long compressedSize,
				long size) {
		...
		/**
		 * Update the original {@link ZipArchiveEntry} with sizes/crc Do not use this
		 * methods from threads that did not create the instance itself !
		 * 
	 ...
	 *
	 * @param target
	 *            The archive to receive the contents of this
	 *            {@link ScatterZipOutputStream}.
	 * @throws IOException
	 *             If writing fails
	 */
	...
	/**
	 * Closes this stream, freeing all resources involved in the creation of this
	 * stream.
	 * 
	 * @throws IOException
	 *             If closing fails
	...
	/**
	 * Create a {@link ScatterZipOutputStream} with default compression level that
	 * is backed by a file
	 *
	 * @param file
	 *            The file to offload compressed data into.
