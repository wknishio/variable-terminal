 ...
 *
 *                <p>
 * 				Since the documentation this class is based upon doesn't
 *                mention the character encoding of the file name at all, it is
 *                assumed that it uses the current platform's default encoding.
 *                </p>
 */
public class AsiExtraField implements ZipExtraField, UnixStat, Cloneable {
	...
	/**
	 * Doesn't do anything special since this class always uses the same data in
