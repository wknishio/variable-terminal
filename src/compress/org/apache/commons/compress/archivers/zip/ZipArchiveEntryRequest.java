...
/**
 * A Thread-safe representation of a ZipArchiveEntry that is used to add entries
 * to parallel archives.
 *
 * @since 1.10
 */
public class ZipArchiveEntryRequest {
	/*
	 * The zipArchiveEntry is not thread safe, and cannot be safely accessed by the
	 * getters of this class. It is safely accessible during the construction part
	 ...
	 * 
	 * @param zipArchiveEntry
	 *            The entry to use
	 * @param payloadSupplier
	 *            The payload that will be added to the zip entry.
	...
	/**
	 * Gets the underlying entry. Do not use this methods from threads that did not
