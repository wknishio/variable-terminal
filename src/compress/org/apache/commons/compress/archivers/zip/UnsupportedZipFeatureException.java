...
/**
 * Exception thrown when attempting to read or write data for a zip entry that
 * uses ZIP features not supported by this library.
 * 
 * @since 1.1
 */
public class UnsupportedZipFeatureException extends ZipException {
	...
	/**
	 * Creates an exception for archives that use an unsupported compression
	 * algorithm.
	 * 
	 * @param method
