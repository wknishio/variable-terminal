 ...
 *
 * <p>
 * The extra data is expected to follow the recommendation of <a href=
 * "http://www.pkware.com/documents/casestudies/APPNOTE.TXT">APPNOTE.TXT</a>:
 * </p>
 * <ul>
...
public class ZipArchiveEntry extends java.util.zip.ZipEntry implements ArchiveEntry {
	...
	/**
	 * The {@link java.util.zip.ZipEntry} base class only supports the compression
	 * methods STORED and DEFLATED. We override the field so that any compression
	 * methods can be used.
	 * <p>
	 ...
	 * 7. Need to keep our own size information for Zip64 support.
	 */
	 ...
	 *
	 * <p>
	 * Assumes the entry represents a directory if and only if the name ends with a
	 * forward slash "/".
	 * </p>
	 *
	 * @param name
	...
	/**
	 * Returns the compression method of this entry, or -1 if the compression method
	 ...
	 *
	 * <p>
	 * <b>Note</b>: {@link ZipArchiveInputStream} is unable to fill this field, you
	 * must use {@link ZipFile} if you want to read entries using this attribute.
	 * </p>
	 *
	...
	/**
	 * Returns true if this entry represents a unix symlink, in which case the
	 ...
	 *
	 * <p>
	 * <b>Note</b>: The set of extra fields may be incomplete when
	 * {@link ZipArchiveInputStream} has been used as some extra fields use the
	 * central directory to store additional information.
	 * </p>
	 *
	 ...
	 * 
	 * @return An array of all extra fields. Not necessarily a copy of internal data
	 ...
	 *
	 * <p>
	 * <b>Note</b>: {@link ZipArchiveInputStream} may create entries that return
	 * {@link #SIZE_UNKNOWN SIZE_UNKNOWN} as long as the entry hasn't been read
	 * completely.
	 * </p>
	 *
	...
	/**
	 * Sets the name using the raw bytes and the string created from it by guessing
	 * or using the configured encoding.
	 * 
	 * @param name
	 *            the name to use created from the raw bytes using the guessed or
	 *            configured encoding
	 * @param rawName
	...
	/**
	 * Returns the raw bytes that made up the name before it has been converted
	 * using the configured or guessed encoding.
	 *
	 * <p>
	 * This method will return null if this instance has not been read from an
	 * archive.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * Changes to the implementation of {@link java.util.zip.ZipEntry#getTime} leak
	...
	public boolean equals(Object obj) {
		...
		return getTime() == other.getTime() && myComment.equals(otherComment)
				&& getInternalAttributes() == other.getInternalAttributes() && getPlatform() == other.getPlatform()
				&& getExternalAttributes() == other.getExternalAttributes() && getMethod() == other.getMethod()
				&& getSize() == other.getSize() && getCrc() == other.getCrc()
