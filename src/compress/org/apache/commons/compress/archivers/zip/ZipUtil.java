...
public abstract class ZipUtil {
	...
	/**
	 * Reverses a byte[] array. Reverses in-place (thus provided array is mutated),
	 * but also returns same for convenience.
	 *
	 * @param array
	...
	/**
	 * Converts a BigInteger into a long, and blows up (NumberFormatException) if
	 * the BigInteger is too big.
	 *
	 * @param big
	 ...
	 * treated as unsigned 32 bit (e.g., positive) integers. Negative numbers below
	 * -2^31 cause an IllegalArgumentException to be thrown.
	 * </p>
	 *
	 * @param l
	 *            long to convert to BigInteger.
	...
	/**
	 * Converts a signed byte into an unsigned integer representation (e.g., -1
	 * becomes 255).
	 *
	 * @param b
