...
public class JarArchiveEntry extends ZipArchiveEntry {
	...
	// These are always null - see https://issues.apache.org/jira/browse/COMPRESS-18
	// for discussion
	...
	/**
	 * This method is not implemented and won't ever be. The JVM equivalent has a
	 * different name {@link java.util.jar.JarEntry#getAttributes()}
	 *
	...
	public Certificate[] getCertificates() {
		...
		/*
		 * Note, the method Certificate[] java.util.jar.JarEntry.getCertificates() also
		 * returns null or the list of certificates (but not copied)
		 */
		return null;
	}
