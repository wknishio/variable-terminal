...
/**
 * Subclass that adds a special extra field to the very first entry which allows
 * the created archive to be used as an executable jar on Solaris.
 * 
 * @NotThreadSafe
 */
public class JarArchiveOutputStream extends ZipArchiveOutputStream {
	 ...
	 * @param encoding
	 *            the encoding to use. Use null for the platform default.
	 * @since 1.10
	 */
