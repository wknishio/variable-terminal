...
public class LZMACompressorInputStream extends CompressorInputStream {
	...
	/**
	 * Creates a new input stream that decompresses LZMA-compressed data from the
	 ...
	 *
	 * @throws IOException
	 *             if the input is not in the .lzma format, the input is corrupt or
	 *             truncated, the .lzma headers specify sizes that are not supported
