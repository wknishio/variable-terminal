...
public class XZCompressorInputStream extends CompressorInputStream {
	...
	/**
	 * Creates a new input stream that decompresses XZ-compressed data from the
	 * specified input stream. This doesn't support concatenated .xz files.
	 *
	 * @param inputStream
	 *            where to read the compressed data
	 *
	 * @throws IOException
	 *             if the input is not in the .xz format, the input is corrupt or
	 *             truncated, the .xz headers specify options that are not supported
	 ...
	 *            after the first .xz stream and leave the input position to point
