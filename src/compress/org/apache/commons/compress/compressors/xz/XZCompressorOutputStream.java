...
public class XZCompressorOutputStream extends CompressorOutputStream {
	 ...
	 * equivalent to <code>XZCompressorOutputStream(outputStream, 6)</code>.
	 * 
	 * @param outputStream
	 *            the stream to wrap
	 * @throws IOException
	 ...
	 * <p>
	 * The presets 0-3 are fast presets with medium compression. The presets 4-6 are
	 * fairly slow presets with high compression. The default preset is 6.
	 * <p>
	...
	/**
	 * Flushes the encoder and calls <code>outputStream.flush()</code>. All buffered
	 * pending data will then be decompressible from the output stream. Calling this
	...
	/**
	 * Finishes compression without closing the underlying stream. No more data can
	 * be written to this stream after finishing.
	 * 
	 * @throws IOException
	 *             on error
	 */
