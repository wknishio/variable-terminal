...
public class XZUtils {
	 ...
	 *
	 * <p>
	 * This is a copy of {@code org.tukaani.xz.XZ.HEADER_MAGIC} in XZ for Java
	 * version 1.5.
	 * </p>
	 */
	 ...
	 *
	 * <p>
	 * This is more or less a copy of the version found in
	 * {@link XZCompressorInputStream} but doesn't depend on the presence of XZ for
	 * Java.
	 * </p>
	 *
	 * @param signature
	 ...
	 * @param filename
	 *            name of a file
	 * @return {@code true} if the filename has a common xz suffix, {@code false}
	 *         otherwise
	 */
	...
	/**
	 * Maps the given name of a xz-compressed file to the name that the file should
	 * have after uncompression. Commonly used file type specific suffixes like
	 * ".txz" are automatically detected and correctly mapped. For example the name
	 * "package.txz" is mapped to "package.tar". And any filenames with the generic
	 * ".xz" suffix (or any other generic xz suffix) is mapped to a name without
	 * that suffix. If no xz suffix is detected, then the filename is returned
	 * unmapped.
	 *
	 * @param filename
	 *            name of a file
	 ...
	 * compression with xz. Common file types with custom suffixes for compressed
	 * versions are automatically detected and correctly mapped. For example the
	 * name "package.tar" is mapped to "package.txz". If no custom mapping is
	 * applicable, then the default ".xz" suffix is appended to the filename.
	 *
	 * @param filename
	 *            name of a file
	 ...
	 *
	 * <p>
	 * This defaults to {@code false} in an OSGi environment and {@code true}
	 * otherwise.
	 * </p>
	 * 
	 * @param doCache
