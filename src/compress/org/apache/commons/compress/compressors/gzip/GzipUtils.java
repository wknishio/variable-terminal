...
public class GzipUtils {
	 ...
	 * @param filename
	 *            name of a file
	 * @return {@code true} if the filename has a common gzip suffix, {@code false}
	 *         otherwise
	 */
	 ...
	 * should have after uncompression. Commonly used file type specific suffixes
	 * like ".tgz" or ".svgz" are automatically detected and correctly mapped. For
	 ...
	 * a name without that suffix. If no gzip suffix is detected, then the filename
	 * is returned unmapped.
	 *
	 * @param filename
	 *            name of a file
	 ...
	 * name "package.tar" is mapped to "package.tgz". If no custom mapping is
	 * applicable, then the default ".gz" suffix is appended to the filename.
	 *
	 * @param filename
	 *            name of a file
