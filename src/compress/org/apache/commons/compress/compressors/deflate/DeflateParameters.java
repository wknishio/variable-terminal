...
public class DeflateParameters {
	...
	/**
	 * Whether or not the zlib header shall be written (when compressing) or
	 * expected (when decompressing).
	 * 
	 ...
	 *
	 * <p>
	 * This affects whether or not the zlib header will be written (when
	 ...
	 *            the compression level (between 0 and 9)
