...
public class Pack200Utils {
	 ...
	 * <p>
	 * As stated in <a href=
	 * "http://download.oracle.com/javase/1.5.0/docs/api/java/util/jar/Pack200.Packer.html">Pack200.Packer's</a>
	 * javadocs applying a Pack200 compression to a JAR archive will in general make
	 * its sigantures invalid. In order to prepare a JAR for signing it should be
	 * "normalized" by packing and unpacking it. This is what this method does.
	 * </p>
	 *
	 * <p>
	 ...
	 *            the JAR archive to normalize
	 * @param props
	 *            properties to set for the pack operation. This method will
	 *            implicitly set the segment limit to -1.
	 * @throws IOException
	 *             if reading or writing fails
	 */
