 ...
 * 
 * <p>
 * The {@link CompressorInputStream#getCount getCount} and
 * {@link CompressorInputStream#getBytesRead getBytesRead} methods always return
 * 0.
 * </p>
 *
 * @NotThreadSafe
...
public class Pack200CompressorInputStream extends CompressorInputStream {
	 ...
	 *
	 * <p>
	 * When reading from a file the File-arg constructor may provide better
	 * performance.
	 * </p>
	 *
	 * @param in
	...
	/**
	 * Decompresses the given stream, caching the decompressed data in memory and
	 ...
	 *             if reading fails
	 */
	public Pack200CompressorInputStream(final InputStream in, final Pack200Strategy mode,
	...
	/**
	 * Decompresses the given file, caching the decompressed data in memory and
	 * using the given properties.
	 *
	 * @param f
	 *            the file to decompress
	...
	/**
	 * Decompresses the given file using the given strategy to cache the results and
	 ...
	 *             if reading fails
	 */
	public Pack200CompressorInputStream(final File f, final Pack200Strategy mode, final Map<String, String> props)
			throws IOException {
		this(null, f, mode, props);
	}

	private Pack200CompressorInputStream(final InputStream in, final File f, final Pack200Strategy mode,
			final Map<String, String> props) throws IOException {
		originalInput = in;
	...
	private static final byte[] CAFE_DOOD = new byte[] { (byte) 0xCA, (byte) 0xFE, (byte) 0xD0, (byte) 0x0D };
	private static final int SIG_LENGTH = CAFE_DOOD.length;

	/**
	 * Checks if the signature matches what is expected for a pack200 file
	 * (0xCAFED00D).
	 * 
	 * @param signature
	 *            the bytes to check
