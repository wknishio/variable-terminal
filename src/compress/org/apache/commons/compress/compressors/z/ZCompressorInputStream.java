...
public class ZCompressorInputStream extends LZWInputStream {
	 ...
	 * {@inheritDoc}
	 * <p>
	 * <strong>This method is only protected for technical reasons and is not part
	 * of Commons Compress' published API. It may change or disappear without
	 * warning.</strong>
	 * </p>
	 */
	 ...
	 * @return true, if this stream is a Unix compress compressed stream, false
	 *         otherwise
	 * 
	 * @since 1.9
	 */
