...
public interface CompressorStreamProvider {
	 ...
	 *            after the first stream and leave the input position to point to
	 *            the next byte after the stream. This setting applies to the gzip,
	 *            bzip2 and xz formats only.
