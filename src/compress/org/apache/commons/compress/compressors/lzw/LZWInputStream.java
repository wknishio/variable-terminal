...
/**
 * <p>
 * Generic LZW implementation. It is used internally for the Z decompressor and
 * the Unshrinking Zip file compression method, but may be useful for
 * third-party projects in implementing their own LZW variations.
 * </p>
 *
 * @NotThreadSafe
 * @since 1.10
...
public abstract class LZWInputStream extends CompressorInputStream {
	...
	/**
	 * Adds a new entry if the maximum table size hasn't been exceeded and returns
	 * the new index.
	 * 
	 * @param previousCode
	 *            the previous code
	...
	/**
	 * Expands the entry with index code to the output stack and may create a new
	 * entry
	 * 
	 * @param code
	 *            the code
	 * @param addedUnfinishedEntry
	 *            whether unfinished entries have been added
