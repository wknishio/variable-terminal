...
public final class Parameters {
	 ...
	 * <code>minBackReferenceLength</code> of 3 and <code>max*Length</code> equal to
	 ...
	 *
	 * @param windowSize
	 *            the size of the sliding window - this determines the maximum
	 *            offset a back-reference can take. Must be a power of two.
	...
	public static class Builder {
		 ...
		 *
		 * <p>
		 * Ensures <code>maxBackReferenceLength</code> is not smaller than
		 ...
		 * </p>
		 *
		 * @param minBackReferenceLength
		 *            the minimal length of a back-reference found. A true minimum of 3
		 *            is hard-coded inside of this implemention but bigger lengths can
		 *            be configured.
		 * @throws IllegalArgumentException
		 *             if <code>windowSize</code> is smaller than
		 *             <code>minBackReferenceLength</code>.
		 * @return the builder
		 */
		 ...
		 * </p>
		 *
		 * @param maxBackReferenceLength
		 *            maximal length of a back-reference found. A value smaller than
		 *            <code>minBackReferenceLength</code> is interpreted as
		 *            <code>minBackReferenceLength</code>.
		 *            <code>maxBackReferenceLength</code> is capped at
		 *            <code>windowSize - 1</code>.
		 * @return the builder
		 */
		 ...
		 *
		 * @param maxOffset
		 *            maximal offset of a back-reference. A non-positive value as well
		 *            as values bigger than <code>windowSize - 1</code> are interpreted
		 *            as <code>windowSize
		 * - 1</code>.
		 * @return the builder
		 */
		 ...
		 * </p>
		 *
		 * @param maxLiteralLength
		 *            maximal length of a literal block. Negative numbers and 0 as well
		 *            as values bigger than <code>windowSize</code> are interpreted as
		 ...
		 *
		 * <p>
		 * When a back-references if this size has been found, stop searching for longer
		 * back-references.
		 * </p>
		 *
		 * <p>
		 * This settings can be used to tune the tradeoff between compression speed and
		 * compression ratio.
		 * </p>
		 * 
		 * @param niceLen
		 *            the "nice length" of a back-reference
		 * @return the builder
		 */
		 ...
		 * 
		 * @param maxCandidates
		 *            maximum number of back-reference candidates
		 * @return the builder
		 */
		 ...
		 *
		 * <p>
		 * Lazy matching means that after a back-reference for a certain position has
		 * been found the compressor will try to find a longer match for the next
		 * position.
		 * </p>
		 *
		 * <p>
		 ...
		 * 
		 * @param lazy
		 *            whether lazy matching should be performed
		 * @return the builder
		 */
		 ...
		 *
		 * <p>
		 * Even if lazy matching is enabled it will not be performed if the length of
		 * the back-reference found for the current position is longer than this value.
		 * </p>
		 * 
		 * @param threshold
		...
		/**
		 * Changes the default setting for "nice back-reference length" and "maximum
		 * number of candidates" for improved compression speed at the cost of
		 * compression ratio.
		 *
		 * <p>
		...
		/**
		 * Changes the default setting for "nice back-reference length" and "maximum
		 * number of candidates" for improved compression ratio at the cost of
		 * compression speed.
		 *
		 * <p>
		 * Use this method after configuring "maximum back-reference length".
		...
		public Parameters build() {
			...
			return new Parameters(windowSize, minBackReferenceLength, maxBackReferenceLength, maxOffset,
					maxLiteralLength, niceLen, candidates, lazy, threshold);
		}
	}
	...
	/**
	 * Gets the size of the sliding window - this determines the maximum offset a
	...
	/**
	 * Gets the length of a back-reference that is considered nice enough to stop
	 * searching for longer ones.
	 * 
	 * @return the length of a back-reference that is considered nice enough to stop
	 *         searching
	 */
