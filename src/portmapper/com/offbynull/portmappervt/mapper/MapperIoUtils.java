 ...
 */
package com.offbynull.portmappervt.mapper;

import static com.offbynull.portmappervt.helpers.NetworkUtils.ZERO_IPV4;
import static com.offbynull.portmappervt.helpers.NetworkUtils.ZERO_IPV6;
...
import com.offbynull.portmappervt.gateway.BasicBus;
import com.offbynull.portmappervt.gateway.Bus;
import com.offbynull.portmappervt.gateways.network.internalmessages.CloseNetworkRequest;
import com.offbynull.portmappervt.gateways.network.internalmessages.CreateTcpNetworkRequest;
import com.offbynull.portmappervt.gateways.network.internalmessages.CreateUdpNetworkRequest;
import com.offbynull.portmappervt.gateways.network.internalmessages.GetLocalIpAddressesNetworkRequest;
import com.offbynull.portmappervt.gateways.network.internalmessages.GetLocalIpAddressesNetworkResponse;
import com.offbynull.portmappervt.gateways.network.internalmessages.GetNextIdNetworkRequest;
import com.offbynull.portmappervt.gateways.network.internalmessages.GetNextIdNetworkResponse;
import com.offbynull.portmappervt.gateways.network.internalmessages.IdentifiableErrorNetworkResponse;
import com.offbynull.portmappervt.gateways.network.internalmessages.ReadClosedTcpNetworkNotification;
import com.offbynull.portmappervt.gateways.network.internalmessages.ReadTcpNetworkNotification;
import com.offbynull.portmappervt.gateways.network.internalmessages.ReadUdpNetworkNotification;
import com.offbynull.portmappervt.gateways.network.internalmessages.WriteTcpNetworkRequest;
import com.offbynull.portmappervt.gateways.network.internalmessages.WriteUdpNetworkRequest;
import com.offbynull.portmappervt.gateways.process.internalmessages.CloseProcessRequest;
import com.offbynull.portmappervt.gateways.process.internalmessages.CreateProcessRequest;
import com.offbynull.portmappervt.gateways.process.internalmessages.ErrorProcessResponse;
import com.offbynull.portmappervt.gateways.process.internalmessages.ExitProcessNotification;
import com.offbynull.portmappervt.gateways.process.internalmessages.GetNextIdProcessRequest;
import com.offbynull.portmappervt.gateways.process.internalmessages.GetNextIdProcessResponse;
import com.offbynull.portmappervt.gateways.process.internalmessages.IdentifiableErrorProcessResponse;
import com.offbynull.portmappervt.gateways.process.internalmessages.ReadProcessNotification;
