...
import static com.offbynull.portmappervt.mapper.MapperIoUtils.getLocalIpAddresses;
import static com.offbynull.portmappervt.mapper.MapperIoUtils.performBatchedTcpRequests;
import static com.offbynull.portmappervt.mapper.MapperIoUtils.performUdpRequests;
...
import org.apache.commons.lang3vt.Range;
import org.apache.commons.lang3vt.Validate;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.offbynull.portmappervt.gateway.Bus;
import com.offbynull.portmappervt.helpers.NetworkUtils;
import com.offbynull.portmappervt.mapper.PortMapper;
import com.offbynull.portmappervt.mapper.MapperIoUtils.BytesToResponseTransformer;
import com.offbynull.portmappervt.mapper.MapperIoUtils.RequestToBytesTransformer;
import com.offbynull.portmappervt.mapper.MapperIoUtils.TcpRequest;
import com.offbynull.portmappervt.mapper.MapperIoUtils.UdpRequest;
import com.offbynull.portmappervt.mappers.upnpigd.externalmessages.RootUpnpIgdRequest;
import com.offbynull.portmappervt.mappers.upnpigd.externalmessages.RootUpnpIgdResponse;
import com.offbynull.portmappervt.mappers.upnpigd.externalmessages.ServiceDescriptionUpnpIgdRequest;
import com.offbynull.portmappervt.mappers.upnpigd.externalmessages.ServiceDescriptionUpnpIgdResponse;
import com.offbynull.portmappervt.mappers.upnpigd.externalmessages.ServiceDiscoveryUpnpIgdRequest;
import com.offbynull.portmappervt.mappers.upnpigd.externalmessages.ServiceDiscoveryUpnpIgdResponse;
import com.offbynull.portmappervt.mappers.upnpigd.externalmessages.UpnpIgdHttpRequest;
import com.offbynull.portmappervt.mappers.upnpigd.externalmessages.RootUpnpIgdResponse.ServiceReference;
import com.offbynull.portmappervt.mappers.upnpigd.externalmessages.ServiceDescriptionUpnpIgdResponse.IdentifiedService;
import com.offbynull.portmappervt.mappers.upnpigd.externalmessages.ServiceDescriptionUpnpIgdResponse.ServiceType;
import com.offbynull.portmappervt.mappers.upnpigd.externalmessages.ServiceDiscoveryUpnpIgdRequest.ProbeDeviceType;
