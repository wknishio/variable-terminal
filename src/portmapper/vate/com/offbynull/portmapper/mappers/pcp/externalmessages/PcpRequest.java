 ...
 */
package vate.com.offbynull.portmapper.mappers.pcp.externalmessages;

import static vate.com.offbynull.portmapper.mappers.pcp.externalmessages.InternalUtils.PCP_VERSION;
...
public abstract class PcpRequest implements PcpMessage {
    ...
    public final byte[] dump() {
        ...
        List<byte[]> optionsData = new ArrayList<byte[]>(options.size());
        for (PcpOption option : options) {
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + VTObjects.hashCode(this.internalIp);
        hash = 97 * hash + VTObjects.hashCode(this.options);
    ...
    public boolean equals(Object obj) {
        ...
        if (!VTObjects.equals(this.internalIp, other.internalIp)) {
            return false;
        }
        if (!VTObjects.equals(this.options, other.options)) {
            return false;
        }
        return true;
    }
