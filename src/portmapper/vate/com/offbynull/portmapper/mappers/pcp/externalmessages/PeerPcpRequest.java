...
public final class PeerPcpRequest extends PcpRequest {
    ...
    public int hashCode() {
        ...
        hash = 43 * hash + VTObjects.hashCode(this.suggestedExternalIpAddress);
        hash = 43 * hash + this.remotePeerPort;
        hash = 43 * hash + VTObjects.hashCode(this.remotePeerIpAddress);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!VTObjects.equals(this.suggestedExternalIpAddress, other.suggestedExternalIpAddress)) {
            return false;
        }
