 ...
 */
package vate.com.offbynull.portmapper.mappers.natpmp.externalmessages;
...
public final class ExternalAddressNatPmpResponse extends NatPmpResponse {
    ...
    public int hashCode() {
        ...
        hash = 53 * hash + VTObjects.hashCode(this.inetAddress);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!VTObjects.equals(this.inetAddress, other.inetAddress)) {
            return false;
        }
        return true;
    }
