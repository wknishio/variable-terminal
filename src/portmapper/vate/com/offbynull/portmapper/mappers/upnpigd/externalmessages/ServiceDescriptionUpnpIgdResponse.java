...
//        Validate.isTrue(isResponseSuccessful());
        ...
        Map<ServiceType, IdentifiedService> descs = new HashMap<ServiceType, IdentifiedService>();
...
//                                       if the firewall is active and accepting inbound
    ...
    public int hashCode() {
        ...
        hash = 17 * hash + VTObjects.hashCode(this.identifiedServices);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!VTObjects.equals(this.identifiedServices, other.identifiedServices)) {
            return false;
        }
        return true;
    }
    ...
    public static final class IdentifiedService {
        ...
        public int hashCode() {
            int hash = 3;
            hash = 59 * hash + VTObjects.hashCode(this.leaseDurationRange);
            hash = 59 * hash + VTObjects.hashCode(this.externalPortRange);
            return hash;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (!VTObjects.equals(this.leaseDurationRange, other.leaseDurationRange)) {
                return false;
            }
            if (!VTObjects.equals(this.externalPortRange, other.externalPortRange)) {
                return false;
            }
            return true;
        }
