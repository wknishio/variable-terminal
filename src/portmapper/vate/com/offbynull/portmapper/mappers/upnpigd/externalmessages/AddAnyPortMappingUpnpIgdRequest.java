...
/**
 * Represents a UPnP AddAnyPortMapping request.
 * <p>
 * For a more thorough description of arguments, see docs at http://upnp.org/specs/gw/igd1 and http://upnp.org/specs/gw/igd2.
 * @author Kasra Faghihi
 */
public final class AddAnyPortMappingUpnpIgdRequest extends UpnpIgdSoapRequest {
    
    /**
     * Constructs a {@link AddAnyPortMappingUpnpIgdRequest} object.
    ...
    public AddAnyPortMappingUpnpIgdRequest(String host, String controlLocation, String serviceType,
            ...
            long leaseDuration) {
    // CHECKSTYLE:ON
        super(host, controlLocation, serviceType, "AddAnyPortMapping",
    ...
    public String toString() {
        return "AddAnyPortMappingUpnpIgdRequest{super=" + super.toString() + '}';
    }
