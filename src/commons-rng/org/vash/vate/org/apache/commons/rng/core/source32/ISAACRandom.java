...
package org.vash.vate.org.apache.commons.rng.core.source32;

import java.util.Arrays;

import org.vash.vate.compatibility.VTArrays;
import org.vash.vate.org.apache.commons.rng.core.util.NumberFactory;
...
public class ISAACRandom extends IntProvider {
    ...
    protected byte[] getStateInternal() {
        final int[] sRsl = VTArrays.copyOf(rsl, SIZE);
        final int[] sMem = VTArrays.copyOf(mem, SIZE);
        final int[] sRem = VTArrays.copyOf(new int[] {count, isaacA, isaacB, isaacC}, 4);
