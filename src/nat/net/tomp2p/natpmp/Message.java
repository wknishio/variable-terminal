 ...
 *
 * Consumers of this class need to ensure that only one message is being sent
 * at a time to remain compliant with the NAT-PMP specification.
 *
...
public abstract class Message {
     ...
     *
     * @param type The {@link MessageType} of the message. This must not be
     * null.
     *
     *
     * @throws NullPointerException Thrown if MessageType is null.
     */
     ...
     * message is received.
     * @throws Throwable Any exception may be thrown by the implementer.
     */
     ...
     * @throws NatPmpException Thrown when no response has been received or the
     ...
     * generally provided by an external entity.
     * @param responseException The {@link NatPmpException} to associate with
     * the response.
     */
    ...
    void notifyListener() {
        ...
        // If an exception is present, report it, otherwise it's a good response.
    ...
    private void internalNotifyListener() throws NatPmpException {
        ...
        if (resultCode != ResultCode.Success) {
            throw new NatPmpException("Message was not successful. The returned message code was " + resultCode.toString() + ".");
        }
     ...
     *
     * @throws NatPmpException Thrown when this message is already being sent or
     * if there is a problem setting up the {@link DatagramSocket}.
     */
