...
public class ChunkHelper {
	...
	public static byte[] toBytesLatin1(String x) {
		try
		{
			return x.getBytes(PngHelperInternal.charsetLatin1.name());
		}
	...
	public static String toStringLatin1(byte[] x) {
		try
		{
			return new String(x, PngHelperInternal.charsetLatin1.name());
		}
		catch (UnsupportedEncodingException e)
		{
	...
	public static String toStringLatin1(byte[] x, int offset, int len) {
		try
		{
			return new String(x, offset, len, PngHelperInternal.charsetLatin1.name());
		}
		catch (UnsupportedEncodingException e)
		{
	...
	public static byte[] toBytesUTF8(String x) {
		try
		{
			return x.getBytes(PngHelperInternal.charsetUTF8.name());
		}
		catch (UnsupportedEncodingException e)
		{
	...
	public static String toStringUTF8(byte[] x) {
		try
		{
			return new String(x, PngHelperInternal.charsetUTF8.name());
		}
		catch (UnsupportedEncodingException e)
		{
	...
	public static String toStringUTF8(byte[] x, int offset, int len) {
		try
		{
			return new String(x, offset, len, PngHelperInternal.charsetUTF8.name());
		}
		catch (UnsupportedEncodingException e)
		{
