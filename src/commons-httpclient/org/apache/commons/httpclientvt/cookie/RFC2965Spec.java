...
package org.apache.commons.httpclientvt.cookie;
...
import org.apache.commons.httpclientvt.Cookie;
import org.apache.commons.httpclientvt.Header;
import org.apache.commons.httpclientvt.HeaderElement;
import org.apache.commons.httpclientvt.NameValuePair;
import org.apache.commons.httpclientvt.util.ParameterFormatter;
...
public class RFC2965Spec extends CookieSpecBase implements CookieVersionSupport {
    ...
    */
    ...
    /**
     * @see #parse(String, int, String, boolean, org.apache.commons.httpclientvt.Header)
     */
     ...
     * {@link org.apache.commons.httpclientvt.Cookie} properties.
     *
     * @param attribute {@link org.apache.commons.httpclientvt.NameValuePair} cookie attribute from the
     * <tt>Set-Cookie2</tt> header.
     * @param cookie {@link org.apache.commons.httpclientvt.Cookie} to be updated
     * @throws MalformedCookieException if an exception occurs during parsing
     */
    ...
    /**
     * Performs RFC 2965 compliant {@link org.apache.commons.httpclientvt.Cookie} validation
     *
     * @param host the host from which the {@link org.apache.commons.httpclientvt.Cookie} was received
     * @param port the port from which the {@link org.apache.commons.httpclientvt.Cookie} was received
     * @param path the path from which the {@link org.apache.commons.httpclientvt.Cookie} was received
     * @param secure <tt>true</tt> when the {@link org.apache.commons.httpclientvt.Cookie} was received using a
     * secure connection
     ...
     * defined in RFC 2965
     * @param cookie a {@link org.apache.commons.httpclientvt.Cookie} to be formatted as string
     ...
     * {@link org.apache.commons.httpclientvt.Cookie}s suitable for
     * sending in a <tt>"Cookie"</tt> header
     * @param cookies an array of {@link org.apache.commons.httpclientvt.Cookie}s to be formatted
  ...
  private class Cookie2MaxageAttributeHandler
      ...
      /**
       * @see CookieAttributeHandler#match(org.apache.commons.httpclientvt.Cookie, String)
       */
      public boolean match(final Cookie cookie, final CookieOrigin origin) {
          return true;
      }
