...
package vate.org.apache.commons.httpclient.cookie;
...
import vate.org.apache.commons.httpclient.Cookie;
import vate.org.apache.commons.httpclient.Header;
import vate.org.apache.commons.httpclient.HeaderElement;
import vate.org.apache.commons.httpclient.NameValuePair;
import vate.org.apache.commons.httpclient.util.ParameterFormatter;
...
public class RFC2965Spec extends CookieSpecBase implements CookieVersionSupport {
    ...
    */
    ...
    /**
     * @see #parse(String, int, String, boolean, vate.org.apache.commons.httpclient.Header)
     */
     ...
     * {@link vate.org.apache.commons.httpclient.Cookie} properties.
     *
     * @param attribute {@link vate.org.apache.commons.httpclient.NameValuePair} cookie attribute from the
     * <tt>Set-Cookie2</tt> header.
     * @param cookie {@link vate.org.apache.commons.httpclient.Cookie} to be updated
     * @throws MalformedCookieException if an exception occurs during parsing
     */
    ...
    /**
     * Performs RFC 2965 compliant {@link vate.org.apache.commons.httpclient.Cookie} validation
     *
     * @param host the host from which the {@link vate.org.apache.commons.httpclient.Cookie} was received
     * @param port the port from which the {@link vate.org.apache.commons.httpclient.Cookie} was received
     * @param path the path from which the {@link vate.org.apache.commons.httpclient.Cookie} was received
     * @param secure <tt>true</tt> when the {@link vate.org.apache.commons.httpclient.Cookie} was received using a
     * secure connection
     ...
     * defined in RFC 2965
     * @param cookie a {@link vate.org.apache.commons.httpclient.Cookie} to be formatted as string
     ...
     * {@link vate.org.apache.commons.httpclient.Cookie}s suitable for
     * sending in a <tt>"Cookie"</tt> header
     * @param cookies an array of {@link vate.org.apache.commons.httpclient.Cookie}s to be formatted
  ...
  private class Cookie2MaxageAttributeHandler
      ...
      /**
       * @see CookieAttributeHandler#match(vate.org.apache.commons.httpclient.Cookie, String)
       */
      public boolean match(final Cookie cookie, final CookieOrigin origin) {
          return true;
      }
