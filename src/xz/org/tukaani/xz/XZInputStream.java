...
public class XZInputStream extends InputStream {
	 ...
	 *             XZ header is valid but specifies options not supported by this
	 *             implementation
	 *
	 * @throws EOFException
	 *             less than 12 bytes of input was available from <code>in</code>
	 *
	 * @throws IOException
	 ...
	 * <p>
	 * This is identical to <code>XZInputStream(InputStream)</code> except that this
	 * takes also the <code>memoryLimit</code> argument.
	 *
	 * @param in
	 *            input stream from which XZ-compressed data is read
	 *
	...
	/**
	 * Creates a new XZ decompressor with an optional memory usage limit and ability
	 * to disable verification of integrity checks.
	 * <p>
	 * This is identical to <code>XZInputStream(InputStream,int)</code> except that
	 * this takes also the <code>verifyCheck</code> argument.
	 * <p>
	 ...
	 * inefficient. Wrap it in {@link java.io.BufferedInputStream} if you need to
	 * read lots of data one byte at a time.
	 *
	 ...
	 * <li>An error is detected after at least one but less <code>len</code> bytes
	 * have already been successfully decompressed. The next call with non-zero
	 * <code>len</code> will immediately throw the pending exception.</li>
