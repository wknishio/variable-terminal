    ...
    extends BufferedBlockCipher
{
     ...
     * @exception org.vtbouncycastle.crypto.DataLengthException if there isn't enough space in out.
     ...
     * @return the number of output bytes copied to out.
     * @exception org.vtbouncycastle.crypto.DataLengthException if there is insufficient space in out for
     * the output.
     * @exception IllegalStateException if the underlying cipher is not
     * initialised.
     * @exception org.vtbouncycastle.crypto.InvalidCipherTextException if cipher text decrypts wrongly (in
