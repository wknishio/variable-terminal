 ...
 *  SimpleBigDecimal</code> is basically a
 * {@link java.math.BigInteger BigInteger} with a few digits on the right of
 * the decimal point. The number of (binary) digits on the right of the decimal
 * point is called the  scale</code> of the  SimpleBigDecimal</code>.
 * Unlike in {@link java.math.BigDecimal BigDecimal}, the scale is not adjusted
 * automatically, but must be set manually. All  SimpleBigDecimal</code>s
 * taking part in the same arithmetic operation must have equal scale. The
 * result of a multiplication of two  SimpleBigDecimal</code>s returns a
 *  SimpleBigDecimal</code> with double scale.
 */
    ...
    //extends Number   // not in J2ME - add compatibility class?
{
    ...
    /**
     * Returns a  SimpleBigDecimal</code> representing the same numerical
     * value as  value</code>.
     * @param value The value of the  SimpleBigDecimal</code> to be
     * created. 
     * @param scale The scale of the  SimpleBigDecimal</code> to be
     * created. 
     * @return The such created  SimpleBigDecimal</code>.
     */
    ...
    /**
     * Constructor for  SimpleBigDecimal</code>. The value of the
     * constructed  SimpleBigDecimal</code> equals  bigInt / 
     * 2 scale</sup></code>.
     * @param bigInt The  bigInt</code> value parameter.
     * @param scale The scale of the constructed  SimpleBigDecimal</code>.
     */
