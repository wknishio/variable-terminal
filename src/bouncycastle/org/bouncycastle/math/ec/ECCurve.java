...
public abstract class ECCurve
{
    ...
    /**
     * Compute a  PreCompInfo</code> for a point on this curve, under a given name. Used by
     *  ECMultiplier</code>s to save the precomputation for this  ECPoint</code> for use
     * by subsequent multiplication.
     * 
     * @param point
     *            The  ECPoint</code> to store precomputations for.
     * @param name
     *            A  String</code> used to index precomputations of different types.
     * @param callback
     *            Called to calculate the  PreCompInfo</code>.
     */
    ...
    /**
     * Sets the default  ECMultiplier</code>, unless already set.
     * 
     ...
     *  F p</sub></code> (X9.62 s 4.2.1 pg 17).
    ...
    public static abstract class AbstractF2m extends ECCurve
    {
        ...
        /**
         * The auxiliary values  s 0</sub></code> and
         *  s 1</sub></code> used for partial modular reduction for
         * Koblitz curves.
         */
...
//                }
        ...
        /**
         * Solves a quadratic equation  z 2</sup> + z = beta</code>(X9.62
         * D.1.6) The other solution is  z + 1</code>.
         * 
         * @param beta
         *            The value to solve the quadratic equation for.
         * @return the solution for  z 2</sup> + z = beta</code> or
         *          null</code> if no solution exists.
         */
        ...
        /**
         * @return the auxiliary values  s 0</sub></code> and
         *  s 1</sub></code> used for partial modular reduction for
         * Koblitz curves.
         */
     ...
     *  y 2</sup> + xy = x 3</sup> + ax 2</sup> + b</code>.
     */
    public static class F2m extends AbstractF2m
    {
        ...
        /**
         * The exponent  m</code> of  F 2 m</sup></sub></code>.
         */
        private int m;  // can't be final - JDK 1.1

        /**
         * TPB: The integer  k</code> where  x m</sup> +
         * x k</sup> + 1</code> represents the reduction polynomial
         *  f(z)</code>. 
         * PPB: The integer  k1</code> where  x m</sup> +
        ...
        /**
         * TPB: Always set to  0</code> 
         * PPB: The integer  k2</code> where  x m</sup> +
         * x k3</sup> + x k2</sup> + x k1</sup> + 1</code>
         * represents the reduction polynomial  f(z)</code>. 
         */
        ...
        /**
         * TPB: Always set to  0</code> 
         * PPB: The integer  k3</code> where  x m</sup> +
         * x k3</sup> + x k2</sup> + x k1</sup> + 1</code>
         * represents the reduction polynomial  f(z)</code>. 
         */
         ...
         *  F 2 m</sup></sub></code>.
         * @param k The integer  k</code> where  x m</sup> +
         * x k</sup> + 1</code> represents the reduction
         * polynomial  f(z)</code>.
         * @param a The coefficient  a</code> in the Weierstrass equation
         * for non-supersingular elliptic curves over
         *  F 2 m</sup></sub></code>.
         * @param b The coefficient  b</code> in the Weierstrass equation
         * for non-supersingular elliptic curves over
         *  F 2 m</sup></sub></code>.
         * @deprecated use constructor taking order/cofactor
         */
         ...
         *  #E a</sub>(F 2 m</sup></sub>) = h * n</code>.
         */
        public F2m(
            int m, 
            int k, 
