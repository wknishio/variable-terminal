...
class Tnaf
{
     ...
     *  &alpha; u</sub></code>'s must be computed differently, see
    ...
    /**
     * The  &alpha; u</sub></code>'s for  a=0</code> as an array
     * of  ZTauElement</code>s.
     */
    ...
    /**
     * The  &alpha; u</sub></code>'s for  a=1</code> as an array
     * of  ZTauElement</code>s.
     */
    ...
    /**
     * Computes the norm of an element  &lambda;</code> of
     *  <b>Z</b>[&tau;]</code>.
     * @param mu The parameter  &mu;</code> of the elliptic curve.
     * @param lambda The element  &lambda;</code> of
     *  <b>Z</b>[&tau;]</code>.
     * @return The norm of  &lambda;</code>.
     */
    ...
    /**
     * Computes the norm of an element  &lambda;</code> of
     *  <b>R</b>[&tau;]</code>, where  &lambda; = u + v&tau;</code>
     * and  u</code> and  u</code> are real numbers (elements of
     *  <b>R</b></code>). 
     * @param mu The parameter  &mu;</code> of the elliptic curve.
     * @param u The real part of the element  &lambda;</code> of
     *  <b>R</b>[&tau;]</code>.
     * @param v The  &tau;</code>-adic part of the element
     *  &lambda;</code> of  <b>R</b>[&tau;]</code>.
     * @return The norm of  &lambda;</code>.
     */
    ...
    /**
     * Rounds an element  &lambda;</code> of  <b>R</b>[&tau;]</code>
     * to an element of  <b>Z</b>[&tau;]</code>, such that their difference
     * has minimal norm.  &lambda;</code> is given as
     *  &lambda; = &lambda; 0</sub> + &lambda; 1</sub>&tau;</code>.
     * @param lambda0 The component  &lambda; 0</sub></code>.
     * @param lambda1 The component  &lambda; 1</sub></code>.
     * @param mu The parameter  &mu;</code> of the elliptic curve. Must
     * equal 1 or -1.
     * @return The rounded element of  <b>Z</b>[&tau;]</code>.
     * @throws IllegalArgumentException if  lambda0</code> and
     *  lambda1</code> do not have same scale.
     */
    ...
    /**
     * Approximate division by  n</code>. For an integer
     *  k</code>, the value  &lambda; = s k / n</code> is
     * computed to  c</code> bits of accuracy.
     * @param k The parameter  k</code>.
     * @param s The curve parameter  s 0</sub></code> or
     *  s 1</sub></code>.
     * @param vm The Lucas Sequence element  V m</sub></code>.
     * @param a The parameter  a</code> of the elliptic curve.
     * @param m The bit length of the finite field
     *  <b>F</b> m</sub></code>.
     * @param c The number of bits of accuracy, i.e. the scale of the returned
     *  SimpleBigDecimal</code>.
     * @return The value  &lambda; = s k / n</code> computed to
     *  c</code> bits of accuracy.
     */
    ...
    /**
     * Computes the  &tau;</code>-adic NAF (non-adjacent form) of an
     * element  &lambda;</code> of  <b>Z</b>[&tau;]</code>.
     * @param mu The parameter  &mu;</code> of the elliptic curve.
     * @param lambda The element  &lambda;</code> of
     *  <b>Z</b>[&tau;]</code>.
     * @return The  &tau;</code>-adic NAF of  &lambda;</code>.
     */
    ...
    /**
     * Applies the operation  &tau;()</code> to an
     *  ECPoint.AbstractF2m</code>. 
     * @param p The ECPoint.AbstractF2m to which  &tau;()</code> is applied.
     * @return  &tau;(p)</code>
     */
    ...
    /**
     * Returns the parameter  &mu;</code> of the elliptic curve.
     * @param curve The elliptic curve from which to obtain  &mu;</code>.
     * The curve must be a Koblitz curve, i.e.  a</code> equals
     *  0</code> or  1</code> and  b</code> equals
     *  1</code>. 
     * @return  &mu;</code> of the elliptic curve.
    ...
    /**
     * Calculates the Lucas Sequence elements  U k-1</sub></code> and
     *  U k</sub></code> or  V k-1</sub></code> and
     *  V k</sub></code>.
     * @param mu The parameter  &mu;</code> of the elliptic curve.
     * @param k The index of the second element of the Lucas Sequence to be
     * returned.
     * @param doV If set to true, computes  V k-1</sub></code> and
     *  V k</sub></code>, otherwise  U k-1</sub></code> and
     *  U k</sub></code>.
     * @return An array with 2 elements, containing  U k-1</sub></code>
     * and  U k</sub></code> or  V k-1</sub></code>
     * and  V k</sub></code>.
     */
...
//            System.out.println();
    ...
    /**
     * Computes the auxiliary value  t w</sub></code>. If the width is
     * 4, then for  mu = 1</code>,  t w</sub> = 6</code> and for
     *  mu = -1</code>,  t w</sub> = 10</code> 
     * @param mu The parameter  &mu;</code> of the elliptic curve.
     * @param w The window width of the WTNAF.
     * @return the auxiliary value  t w</sub></code>
     */
...
//            System.out.println("tw = " + tw);
    ...
    /**
     * Computes the auxiliary values  s 0</sub></code> and
     *  s 1</sub></code> used for partial modular reduction. 
     * @param curve The elliptic curve for which to compute
     *  s 0</sub></code> and  s 1</sub></code>.
     * @throws IllegalArgumentException if  curve</code> is not a
     ...
     *  (&tau; m</sup> - 1)/(&tau; - 1)</code>.
     * @param k The integer to be reduced.
     * @param m The bitlength of the underlying finite field.
     * @param a The parameter  a</code> of the elliptic curve.
     * @param s The auxiliary values  s 0</sub></code> and
     *  s 1</sub></code>.
     * @param mu The parameter &mu; of the elliptic curve.
     * @param c The precision (number of bits of accuracy) of the partial
     * modular reduction.
     * @return  &rho; := k partmod (&tau; m</sup> - 1)/(&tau; - 1)</code>
     */
     ...
     * by a  BigInteger</code> using the reduced  &tau;</code>-adic
     * NAF (RTNAF) method.
     * @param p The ECPoint.AbstractF2m to multiply.
     * @param k The  BigInteger</code> by which to multiply  p</code>.
     * @return  k * p</code>
     */
    ...
    /**
     * Multiplies a {@link org.bouncycastle.math.ec.ECPoint.AbstractF2m ECPoint.AbstractF2m}
     * by an element  &lambda;</code> of  <b>Z</b>[&tau;]</code>
     * using the  &tau;</code>-adic NAF (TNAF) method.
     * @param p The ECPoint.AbstractF2m to multiply.
     * @param lambda The element  &lambda;</code> of
     *  <b>Z</b>[&tau;]</code>.
     * @return  &lambda; * p</code>
     */
    ...
    * Multiplies a {@link org.bouncycastle.math.ec.ECPoint.AbstractF2m ECPoint.AbstractF2m}
    * by an element  &lambda;</code> of  <b>Z</b>[&tau;]</code>
    * using the  &tau;</code>-adic NAF (TNAF) method, given the TNAF
    * of  &lambda;</code>.
    * @param p The ECPoint.AbstractF2m to multiply.
    * @param u The the TNAF of  &lambda;</code>..
    * @return  &lambda; * p</code>
    */
    ...
    /**
     * Computes the  [&tau;]</code>-adic window NAF of an element
     *  &lambda;</code> of  <b>Z</b>[&tau;]</code>.
     * @param mu The parameter &mu; of the elliptic curve.
     * @param lambda The element  &lambda;</code> of
     *  <b>Z</b>[&tau;]</code> of which to compute the
     *  [&tau;]</code>-adic NAF.
     * @param width The window width of the resulting WNAF.
     * @param pow2w 2 width</sup>.
     * @param tw The auxiliary value  t w</sub></code>.
     * @param alpha The  &alpha; u</sub></code>'s for the window width.
     * @return The  [&tau;]</code>-adic window NAF of
     *  &lambda;</code>.
     */
     ...
     * @param p The  ECPoint</code> for which to do the precomputation.
     * @param a The parameter  a</code> of the elliptic curve.
     * @return The precomputation array for  p</code>. 
     */
