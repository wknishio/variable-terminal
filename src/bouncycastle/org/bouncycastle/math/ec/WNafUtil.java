...
public abstract class WNafUtil
{
     ...
     * @param width The width  w</code> of the Window NAF. The width is
     * defined as the minimal number  w</code>, such that for any
     *  w</code> consecutive digits in the resulting representation, at
     * most one is non-zero.
     * @param k The integer of which the Window NAF is computed.
     * @return The Window NAF of the given width, such that the following holds:
     *  k = &sum; i=0</sub> l-1</sup> k i</sub>2 i</sup>
     * </code>, where the  k i</sub></code> denote the elements of the
     * returned  byte[]</code>.
     */
