...
//            }
     ...
     *  F 2 m</sup></sub></code> in polynomial basis (PB)
    ...
    public static class F2m extends AbstractF2m
    {
        ...
        /**
         * The  LongArray</code> holding the bits.
         */
        LongArray x;
        ...
        /**
         * @return the degree  m</code> of the reduction polynomial
         *  f(z)</code>.
         */
        public int getM()
        {
        ...
        /**
         * @return TPB: The integer  k</code> where  x m</sup> +
        ...
        /**
         * @return TPB: Always returns  0</code> 
        ...
        /**
         * @return TPB: Always set to  0</code> 
