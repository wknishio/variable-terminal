...
/**
 *  DisplayText</code> class, used in
 *  CertificatePolicies</code> X509 V3 extensions (in policy qualifiers).
 *
    ...
    implements ASN1Choice
{
   ...
   /**
    * Describe constant  DISPLAY_TEXT_MAXIMUM_SIZE</code> here.
    *
    */
   ...
   /**
    * Creates a new  DisplayText</code> instance.
    *
   ...
   /**
    * Creates a new  DisplayText</code> instance.
    * <p>Useful when reading back a  DisplayText</code> class
    * from it's ASN1Encodable/DEREncodable form. 
    *
    * @param de a  DEREncodable</code> instance. 
    */
   ...
   /**
    * Returns the stored  String</code> object. 
    *
    * @return the stored text as a  String</code>. 
    */
