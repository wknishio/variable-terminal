    ...
    implements NameConstraintValidator
{
     ...
     * @throws NameConstraintValidatorException If the  name</code>
     */
     ...
     *
     * @param name The GeneralName.
     * @throws NameConstraintValidatorException If the  name</code> is
     * excluded.
     */
     ...
     *  permitted</code> with  ip</code>.
     *
     * @param permitted A  Set</code> of permitted IP addresses with
     *                  their subnet mask as byte arrays.
     * @param ips       The IP address with its subnet mask.
     * @return The  Set</code> of permitted IP ranges intersected with
     *  ip</code>.
     */
    ...
    /**
     * Returns the union of the excluded IP ranges in  excluded</code>
     * with  ip</code>.
     *
     * @param excluded A  Set</code> of excluded IP addresses with their
     *                 subnet mask as byte arrays.
     * @param ip       The IP address with its subnet mask.
     * @return The  Set</code> of excluded IP ranges unified with
     *  ip</code> as byte arrays.
     */
     ...
     * @return A  Set</code> with the union of both addresses.
     */
     ...
     * @param ipWithSubmask1 The first IP address with its subnet mask.
     * @param ipWithSubmask2 The second IP address with its subnet mask.
     * @return A  Set</code> with the single IP address with its subnet
     * mask as a byte array or an empty  Set</code>.
     */
    ...
    /**
     * Checks if the IP  ip</code> is included in the permitted set
     *  permitted</code>.
     *
     * @param permitted A  Set</code> of permitted IP addresses with
     *                  their subnet mask as byte arrays.
    ...
    /**
     * Checks if the IP  ip</code> is included in the excluded set
     *  excluded</code>.
     *
     * @param excluded A  Set</code> of excluded IP addresses with their
     *                 subnet mask as byte arrays.
    ...
    /**
     * Checks if the IP address  ip</code> is constrained by
     *  constraint</code>.
     *
     * @param ip         The IP address.
     * @param constraint The constraint. This is an IP address concatenated with
     *                   its subnetmask.
     * @return  true</code> if constrained,  false</code>
     * otherwise.
     */
    ...
    /**
     * The common part of  email1</code> and  email2</code> is
     * added to the union  union</code>. If  email1</code> and
     *  email2</code> have nothing in common they are added both.
     *
    ...
    /**
     * The most restricting part from  email1</code> and
     *  email2</code> is added to the intersection  intersect</code>.
     *
     * @param email1    Email address constraint 1.
     * @param email2    Email address constraint 2.
    ...
    /**
     * Compares IP address  ip1</code> with  ip2</code>. If ip1
    ...
    /**
     * Returns the logical OR of the IP addresses  ip1</code> and
     *  ip2</code>.
     *
     * @param ip1 The first IP address.
     * @param ip2 The second IP address.
     * @return The OR of  ip1</code> and  ip2</code>.
     */
