 ...
 *  
 *   ASN1Boolean.TRUE literal</li>
 *   ASN1Boolean.FALSE literal</li>
 *   {@link ASN1Boolean#getInstance(boolean) ASN1Boolean.getInstance(boolean)}</li>
 *   {@link ASN1Boolean#getInstance(int) ASN1Boolean.getInstance(int)}</li>
 * </ul>
 */
