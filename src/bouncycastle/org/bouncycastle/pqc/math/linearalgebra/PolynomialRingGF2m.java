...
/**
 * This class represents polynomial rings  GF(2^m)[X]/p(X)</tt> for
 *  m&lt;32</tt>. If  p(X)</tt> is irreducible, the polynomial ring
 * is in fact an extension field of  GF(2^m)</tt>.
 */
