...
public final class LittleEndianConversions
{
     ...
     * @return an integer representing the octet string  input</tt>
    ...
    /**
     * Convert an byte array of length 4 beginning at  offset</tt> into an
     * integer.
     *
    ...
    /**
     * Convert a byte array of the given length beginning at  offset</tt>
     * into an integer.
     *
     * @param input the byte array
     * @param inOff the offset into the byte array
     ...
     *  length</tt> octets, it is truncated).
     *
     * @param value  the integer to convert
     * @param output the byte array to hold the result
     * @param outOff the integer offset into the byte array
