...
public final class ByteUtils
{
     ...
     * @return the clone of the given array, or  null</tt> if the array is
     *          null</tt>
     */
    ...
    /**
     * Split a byte array  input</tt> into two arrays at  index</tt>,
     * i.e. the first array will have the lower  index</tt> bytes, the
     * second one the higher  input.length - index</tt> bytes.
     *
     ...
     * @throws ArrayIndexOutOfBoundsException if  index</tt> is out of bounds
     */
     ...
     * @return a subarray of  input</tt>, ranging from  start</tt>
     *         (inclusively) to  end</tt> (exclusively)
     */
     ...
     * @param input the input byte array
     * @param start the start index
     * @return a subarray of  input</tt>, ranging from  start</tt> to
