...
/**
 * This class implements the abstract class  Vector</tt> for the case of
    ...
    extends Vector
{
    ...
    /**
     * Return a new vector consisting of the first  k</tt> elements of this
     * vector.
     *
     * @param k the number of elements to extract
     * @return a new {@link GF2Vector} consisting of the first  k</tt>
    ...
    /**
     * Return a new vector consisting of the last  k</tt> elements of this
     * vector.
     *
     * @param k the number of elements to extract
     * @return a new {@link GF2Vector} consisting of the last  k</tt>
     *         elements of this vector
     */
    ...
    /**
     * Rewrite this vector as a vector over  GF(2 m</sup>)</tt> with
     *  t</tt> elements.
     *
     * @param field the finite field  GF(2 m</sup>)</tt>
     * @return the converted vector over  GF(2 m</sup>)</tt>
     */
