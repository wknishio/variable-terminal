...
public final class GoppaCode
{
     ...
     *  S*H*P = (Id|M)</tt> of the check matrix  H</tt> as returned by
    ...
    /**
     * Given a check matrix  H</tt>, compute matrices  S</tt>,
     *  M</tt>, and a random permutation  P</tt> such that
     *  S*H*P = (Id|M)</tt>. Return  S^-1</tt>,  M</tt>, and
     *  P</tt> as {@link MaMaPe}. The matrix  (Id | M)</tt> is called
     * the systematic form of H.
     *
     * @param h  the check matrix
     * @param sr a source of randomness
     * @return the tuple  (S^-1, M, P)</tt>
     */
    ...
    /**
     * Find an error vector  e</tt> over  GF(2)</tt> from an input
     * syndrome  s</tt> over  GF(2 m</sup>)</tt>.
     *
