 ...
 * &gt; 0, i.e., ordered sequences containing each number  m</tt> ( 0 &lt;=
 * m &lt; n</tt>)
 * once and only once.
 */
public class Permutation
{
    ...
    /**
     * @return the permutation vector  (perm(0),perm(1),[],perm(n-1))</tt>
     */
    ...
    /**
     * Compute the inverse permutation  P -1</sup></tt>.
     *
     * @return  this -1</sup></tt>
     */
