    ...
    extends Matrix
{
     ...
     *
     * @return  true</tt> if this is the zero matrix
     */
     ...
     *  numRows</tt> columns.
     *
     * @return the  (numRows x numRows)</tt> submatrix
     */
    ...
    /**
     * Compute the full form matrix  (this | Id)</tt> from this matrix in
     * left compact form, where  Id</tt> is the  k x k</tt> identity
     * matrix and  k</tt> is the number of rows of this matrix.
     *
     * @return  (this | Id)</tt>
     */
     ...
     *  numColumns-numRows</tt> columns.
     *
     * @return the  (numRows x (numColumns-numRows))</tt> submatrix
     */
    ...
    /**
     * Compute the full form matrix  (Id | this)</tt> from this matrix in
     * right compact form, where  Id</tt> is the  k x k</tt> identity
     * matrix and  k</tt> is the number of rows of this matrix.
     *
     * @return  (Id | this)</tt>
     */
     ...
     * @return {@link GF2Matrix}  P*this</tt>
     */
    ...
    /**
     * Compute the product of the matrix  (this | Id)</tt> and a column
     * vector, where  Id</tt> is a  (numRows x numRows)</tt> unit
     * matrix.
     *
     * @param vec the vector over GF(2)
     * @return  (this | Id)*vector</tt>
     */
     ...
     * @return matrix product  this*matrixA</tt>
     */
     ...
     *
     * @param p the permutation
     * @return {@link GF2Matrix}  this*P</tt>
     */
    ...
    /**
     * Compute the product of the matrix  (Id | this)</tt> and a column
     * vector, where  Id</tt> is a  (numRows x numRows)</tt> unit
     * matrix.
     *
     * @param vec the vector over GF(2)
     * @return  (Id | this)*vector</tt>
     */
