...
public final class BigEndianConversions
{
     ...
     * @return an octet string of length  oLen</tt> representing the
     *         integer  x</tt>, or  null</tt> if the integer is
     *         negative
     * @throws ArithmeticException if  x</tt> can't be encoded into  oLen</tt>
     * octets.
     */
     ...
     * the integer cannot be encoded into  length</tt> octets, it is
     * truncated).
     *
     * @param input  the integer to convert
     * @param output byte array holding the output
     ...
     * @return an integer representing the octet string  input</tt>, or
     *          0</tt> if the represented integer is negative or too large
    ...
    /**
     * Convert a byte array of length 4 beginning at  offset</tt> into an
     * integer.
     *
     ...
     * @return an integer representing the octet string  bytes</tt>, or
     *          0</tt> if the represented integer is negative or too large
     *         or the byte array is empty
     */
    ...
    /**
     * Convert a byte array of length 8 beginning at  inOff</tt> into a
     * long integer.
     *
     * @param input the byte array
     * @param inOff the offset into the byte array
     ...
     *  length % 4</tt> octets, it is truncated).
     *
     * @param input  the int array
