    ...
    extends GMSSKeyParameters
{
     ...
     *  layer</code>, and the LEAF++^1 for the next next tree in the
    ...
    /**
     * Computes the upcoming currentAuthpath of layer  layer</code> using
     ...
     * @return The largest  h</code> with  2^h | Phi</code> if
     *          Phi!=0</code> else return  -1</code>
     */
     ...
     * next (AUTH++, ROOT++) in layer  layer</code>
     *
     * @param layer
     */
