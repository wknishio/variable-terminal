    ...
    extends McElieceKeyParameters
{
    ...
    // the dimension of the code, where  k &gt;= n - mt</tt>
    private int k;
    ...
    // the matrix used to compute square roots in  (GF(2^m))^t</tt>
...
*                  matrix
     * @param sInv      the matrix  S -1</sup></tt>
     */
     ...
     * @param encSInv      the encoded matrix  S -1</sup></tt>
    ...
    /**
     * @return the finite field  GF(2 m</sup>)</tt>
     */
