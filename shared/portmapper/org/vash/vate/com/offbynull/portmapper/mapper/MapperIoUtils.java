 ...
 */
package org.vash.vate.com.offbynull.portmapper.mapper;

import static org.vash.vate.com.offbynull.portmapper.helpers.NetworkUtils.ZERO_IPV4;
import static org.vash.vate.com.offbynull.portmapper.helpers.NetworkUtils.ZERO_IPV6;
...
import org.vash.vate.com.offbynull.portmapper.gateways.network.internalmessages.CreateTcpNetworkRequest;
import org.vash.vate.com.offbynull.portmapper.gateways.network.internalmessages.CreateUdpNetworkRequest;
import org.vash.vate.com.offbynull.portmapper.gateways.network.internalmessages.GetLocalIpAddressesNetworkRequest;
import org.vash.vate.com.offbynull.portmapper.gateways.network.internalmessages.GetLocalIpAddressesNetworkResponse;
import org.vash.vate.com.offbynull.portmapper.gateways.network.internalmessages.GetNextIdNetworkRequest;
import org.vash.vate.com.offbynull.portmapper.gateways.network.internalmessages.GetNextIdNetworkResponse;
import org.vash.vate.com.offbynull.portmapper.gateways.network.internalmessages.IdentifiableErrorNetworkResponse;
import org.vash.vate.com.offbynull.portmapper.gateways.network.internalmessages.ReadClosedTcpNetworkNotification;
import org.vash.vate.com.offbynull.portmapper.gateways.network.internalmessages.ReadTcpNetworkNotification;
import org.vash.vate.com.offbynull.portmapper.gateways.network.internalmessages.ReadUdpNetworkNotification;
import org.vash.vate.com.offbynull.portmapper.gateways.network.internalmessages.WriteTcpNetworkRequest;
import org.vash.vate.com.offbynull.portmapper.gateways.network.internalmessages.WriteUdpNetworkRequest;
import org.vash.vate.com.offbynull.portmapper.gateways.process.internalmessages.CloseProcessRequest;
import org.vash.vate.com.offbynull.portmapper.gateways.process.internalmessages.CreateProcessRequest;
import org.vash.vate.com.offbynull.portmapper.gateways.process.internalmessages.ErrorProcessResponse;
import org.vash.vate.com.offbynull.portmapper.gateways.process.internalmessages.ExitProcessNotification;
import org.vash.vate.com.offbynull.portmapper.gateways.process.internalmessages.GetNextIdProcessRequest;
import org.vash.vate.com.offbynull.portmapper.gateways.process.internalmessages.GetNextIdProcessResponse;
import org.vash.vate.com.offbynull.portmapper.gateways.process.internalmessages.IdentifiableErrorProcessResponse;
