...
import org.vash.vate.com.googlecode.lanterna.TextCharacter;
...
public class AWTTerminalFontConfiguration {
  ...
  static
  {
	...
	private static float baseFontSize = VTFontManager.BASE_FONT_SIZE_MONOSPACED;
    /**
	...
	private static float FONT_SCALING_FACTOR = VTFontManager.FONT_SCALING_FACTOR_MONOSPACED;
    ...
    private static List<Font> getDefaultWindowsFonts() {
        ...
        return (Arrays.asList(
                ...
                VTFontManager.CUSTOM_MONOSPACED_FONT_PLAIN.deriveFont(fontSize),
    ...
    private static float getDefaultFontSize() {
        ...
        return VTFontManager.CUSTOM_MONOSPACED_FONT_PLAIN.getSize2D();
...
//        return defaultFonts.toArray(new Font[defaultFonts.size()]);
    ...
    private static class VTFontManager
    {
