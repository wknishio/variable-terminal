 ...
 *******************************************************************************/
package org.vash.vate.org.iq80.snappy;

import static org.vash.vate.org.iq80.snappy.Crc32C.maskedCrc32c;
import static org.vash.vate.org.iq80.snappy.Snappy.maxCompressedLength;
import static org.vash.vate.org.iq80.snappy.SnappyInternalUtils.checkArgument;
import static org.vash.vate.org.iq80.snappy.SnappyInternalUtils.checkNotNull;
import static org.vash.vate.org.iq80.snappy.SnappyInternalUtils.checkPositionIndexes;
        ...
        extends OutputStream
{
    ...
    //protected boolean sentStreamHeader = false;
    protected boolean calculateChecksums = true;
     ...
     */
    public AbstractSnappyOutputStream(OutputStream out, int blockSize, double minCompressionRatio, boolean calculateChecksums)
            throws IOException
    {
