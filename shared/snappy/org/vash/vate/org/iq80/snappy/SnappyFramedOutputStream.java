...
import static org.vash.vate.org.iq80.snappy.SnappyFramed.COMPRESSED_DATA_FLAG;
import static org.vash.vate.org.iq80.snappy.SnappyFramed.HEADER_BYTES;
import static org.vash.vate.org.iq80.snappy.SnappyFramed.UNCOMPRESSED_DATA_FLAG;
        ...
        extends AbstractSnappyOutputStream
{
    ...
    public SnappyFramedOutputStream(OutputStream out, boolean calculateChecksums)
            throws IOException
    {
        this(out, DEFAULT_BLOCK_SIZE, DEFAULT_MIN_COMPRESSION_RATIO, calculateChecksums);
    }

    public SnappyFramedOutputStream(OutputStream out, int blockSize,
            double minCompressionRatio, boolean calculateChecksums)
            throws IOException
    {
        super(out, blockSize, minCompressionRatio, calculateChecksums);
