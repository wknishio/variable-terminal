...
import org.vash.vate.net.sourceforge.jsocks.socks.InetRange;
import org.vash.vate.net.sourceforge.jsocks.socks.ProxyMessage;
...
public class IdentAuthenticator extends ServerAuthenticatorNone {
	 ...
	 *            OutputStream.
	 * @param user
	 *            Username associated with this connection,could be null if name was
	 *            not required.
	 */
	 ...
	 * should contain user names as keys and anything as values (value is not used
	 * and will be ignored).
	 * 
	 * @param hostRange
	 ...
	 *            indicate that anybody is allowed to connect from the hosts within
	 *            given range.
	 */
	...
	/**
	 * For SOCKS5 requests allways returns true. For SOCKS4 requests checks wether
	 * the user name supplied in the request corresponds to the name obtained from
	 * the ident daemon.
	 */
