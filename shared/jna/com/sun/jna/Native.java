...
public final class Native implements Version {
    ...
    public static String toString(byte[] buf, Charset charset) {
        ...
        try
        {
          return new String(buf, 0, len, charset.name());
        }
    ...
    */
    ...
    public static File extractFromResourcePath(String name, ClassLoader loader) throws IOException {
        ...
        if (url.getProtocol().toLowerCase().equals("file")) {
            ...
            InputStream is = createByteArrayInputStreamFromInputStream(loader.getResourceAsStream(resourcePath));
            if (is == null) {
            ...
            else
            {
                try
                {
                    File searched = searchMatchingFileInFolder(JNA_TMPLIB_PREFIX, Platform.isWindows()?".dll":"", is.available(), getTempDir());
                    if (searched != null) {
                        return searched;
                    }
                }
    ...
    static File getTempDir() throws IOException {
        ...
        if (prop != null) {
            ...
            if(Platform.isMac()) {
                ...
                File xdgCacheFile;
                if(xdgCacheEnvironment == null || xdgCacheEnvironment.trim().length() == 0) {
