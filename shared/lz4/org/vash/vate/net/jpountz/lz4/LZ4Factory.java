...
import static org.vash.vate.net.jpountz.lz4.LZ4Constants.MAX_COMPRESSION_LEVEL;
...
public final class LZ4Factory {
  ...
  private LZ4Factory(String impl) throws ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException {
    this.impl = impl;
    fastCompressor = classInstance("org.vash.vate.net.jpountz.lz4.LZ4" + impl + "Compressor");
    highCompressor = classInstance("org.vash.vate.net.jpountz.lz4.LZ4HC" + impl + "Compressor");
    fastDecompressor = classInstance("org.vash.vate.net.jpountz.lz4.LZ4" + impl + "FastDecompressor");
    safeDecompressor = classInstance("org.vash.vate.net.jpountz.lz4.LZ4" + impl + "SafeDecompressor");
