...
import static org.vash.vate.io.airlift.compress.zstd.Constants.MAX_WINDOW_LOG;
import static org.vash.vate.io.airlift.compress.zstd.Constants.MIN_WINDOW_LOG;
import static org.vash.vate.io.airlift.compress.zstd.ZstdUtil.cycleLog;
import static org.vash.vate.io.airlift.compress.zstd.ZstdUtil.highestBit;
    ...
    private static final CompressionParameters[][] DEFAULT_COMPRESSION_PARAMETERS = new CompressionParameters[][] {
            {
                ...
                new CompressionParameters(20, 17, 17, 2, 4, 1, Strategy.DFAST),  /* level  3 */
            ...
            },
            {
                ...
                new CompressionParameters(18, 16, 16, 2, 4, 1, Strategy.DFAST),  /* level  3 */
            ...
            },
            {
                ...
                new CompressionParameters(17, 16, 16, 2, 4, 1, Strategy.DFAST),  /* level  3 */
            ...
            },
            {
              ...
              new CompressionParameters(16, 16, 16, 2, 4, 1, Strategy.DFAST),  /* level  3.*/
          ...
          },
          {
            ...
            new CompressionParameters(15, 15, 15, 2, 4, 1, Strategy.DFAST),  /* level  3.*/
