...
package org.vash.vate.org.apache.commons.rng.core;
...
public abstract class BaseProvider {
     ...
     * {@link org.vash.vate.org.apache.commons.rng.core.source64.SplitMix64 SplitMix64}
    ...
    protected static long[] extendSeed(long[] seed, int length) {
        if (seed.length < length) {
            final long[] s = VTArrays.copyOf(seed, length);
     ...
     *
     * <p>This method functions as if the seed has been extended using a
     * {@link org.vash.vate.org.apache.commons.rng.core.source64.SplitMix64 SplitMix64}-style 32-bit
    ...
    protected static int[] extendSeed(int[] seed, int length) {
        if (seed.length < length) {
            final int[] s = VTArrays.copyOf(seed, length);
     ...
     * {@link org.vash.vate.org.apache.commons.rng.core.source64.SplitMix64 SplitMix64} RNG.
     *
