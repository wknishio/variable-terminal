...
class HuffmanCompressionTableWorkspace
{
    ...
    public final int[] entriesPerRank = new int[Huffman.MAX_TABLE_LOG + 1];
    public final int[] valuesPerRank = new int[Huffman.MAX_TABLE_LOG + 1];
    ...
    public void reset()
    {
        Arrays.fill(entriesPerRank, 0);
        Arrays.fill(valuesPerRank, 0);
    }
}
